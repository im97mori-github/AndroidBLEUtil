...
public class RingerSettingTest {
    ...
    public void test_constructor001() {
        ...
        RingerSetting result1 = new RingerSetting(bluetoothGattCharacteristic);
    ...
    public void test_parcelable001() {
        ...
        RingerSetting result2 = RingerSetting.CREATOR.createFromParcel(parcel);
    ...
    public void test_parcelable003() {
        ...
        RingerSetting result1 = new RingerSetting(bluetoothGattCharacteristic);
        RingerSetting result2 = RingerSetting.CREATOR.createFromByteArray(data);
