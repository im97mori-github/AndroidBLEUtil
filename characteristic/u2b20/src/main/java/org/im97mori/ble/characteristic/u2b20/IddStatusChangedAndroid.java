...
public class IddStatusChangedAndroid extends IddStatusChanged implements Parcelable {
     ...
     */
    public static final ByteArrayCreator<IddStatusChangedAndroid> CREATOR = new ByteArrayCreator<IddStatusChangedAndroid>() {
        ...
        public IddStatusChangedAndroid createFromByteArray(@NonNull byte[] values) {
            return new IddStatusChangedAndroid(values);
        }
     ...
     */
    public IddStatusChangedAndroid(@NonNull byte[] values) {
        super(values);
    }
