...
public class BodyCompositionMeasurementTest {
    ...
    public void test_constructor002() {
        ...
        BodyCompositionMeasurement result1 = new BodyCompositionMeasurement(new BodyCompositionMeasurementPacket[]{BodyCompositionMeasurementPacket.CREATOR.createFromByteArray(data1), BodyCompositionMeasurementPacket.CREATOR.createFromByteArray(data2)});
