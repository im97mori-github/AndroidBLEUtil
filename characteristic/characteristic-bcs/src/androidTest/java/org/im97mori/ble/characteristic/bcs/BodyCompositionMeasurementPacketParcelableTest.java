...
public class BodyCompositionMeasurementPacketParcelableTest {
    ...
    public void test_parcelable001() {
        ...
        BodyCompositionMeasurementPacket result2 = BodyCompositionMeasurementPacket.CREATOR.createFromParcel(parcel);
    ...
    public void test_parcelable063() {
        ...
        BodyCompositionMeasurementPacket bodyCompositionMeasurementPacket = BodyCompositionMeasurementPacket.CREATOR.createFromByteArray(data);
        BodyCompositionMeasurement result1 = new BodyCompositionMeasurement(new BodyCompositionMeasurementPacket[]{bodyCompositionMeasurementPacket});
        Parcel parcel = Parcel.obtain();
        result1.writeToParcel(parcel, 0);
        parcel.setDataPosition(0);
    ...
    public void test_parcelable201() {
        ...
        BodyCompositionMeasurementPacket result1 = new BodyCompositionMeasurementPacket(bluetoothGattCharacteristic);
        BodyCompositionMeasurementPacket result2 = BodyCompositionMeasurementPacket.CREATOR.createFromByteArray(data);
