...
public class BodyCompositionFeatureTest {
    ...
    public void test_constructor001() {
        ...
        BodyCompositionFeature result1 = new BodyCompositionFeature(bluetoothGattCharacteristic);
    ...
    public void test_parcelable001() {
        ...
        BodyCompositionFeature result2 = BodyCompositionFeature.CREATOR.createFromParcel(parcel);
        ...
        assertEquals(result1.isImpedanceMassSupported(), result2.isImpedanceMassSupported());
        assertEquals(result1.isImpedanceNotSupported(), result2.isImpedanceNotSupported());
        assertEquals(result1.isWeightMassSupported(), result2.isWeightMassSupported());
        assertEquals(result1.isWeightNotSupported(), result2.isWeightNotSupported());
        assertEquals(result1.isHeightMassSupported(), result2.isHeightMassSupported());
    ...
    public void test_parcelable003() {
        ...
        BodyCompositionFeature result1 = new BodyCompositionFeature(bluetoothGattCharacteristic);
        BodyCompositionFeature result2 = BodyCompositionFeature.CREATOR.createFromByteArray(data);
