...
public class SupportedUnreadAlertCategoryAndroidTest extends TestBase {
    ...
    public void test_constructor_00001() {
        ...
        SupportedUnreadAlertCategoryAndroid result1 = new SupportedUnreadAlertCategoryAndroid(data);
