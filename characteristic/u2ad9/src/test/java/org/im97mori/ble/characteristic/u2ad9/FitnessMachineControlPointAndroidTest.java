...
public class FitnessMachineControlPointAndroidTest extends TestBase {
    ...
    public void test_constructor_00001() {
        ...
        FitnessMachineControlPointAndroid result1 = new FitnessMachineControlPointAndroid(data);
