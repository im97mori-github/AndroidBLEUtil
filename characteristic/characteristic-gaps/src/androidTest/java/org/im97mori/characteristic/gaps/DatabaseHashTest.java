...
public class DatabaseHashTest {
    ...
    public void test_constructor001() {
        ...
        DatabaseHash result1 = new DatabaseHash(bluetoothGattCharacteristic);
    ...
    public void test_parcelable001() {
        ...
        DatabaseHash result2 = DatabaseHash.CREATOR.createFromParcel(parcel);
    ...
    public void test_parcelable003() {
        ...
        DatabaseHash result1 = new DatabaseHash(bluetoothGattCharacteristic);
        DatabaseHash result2 = DatabaseHash.CREATOR.createFromByteArray(data);
