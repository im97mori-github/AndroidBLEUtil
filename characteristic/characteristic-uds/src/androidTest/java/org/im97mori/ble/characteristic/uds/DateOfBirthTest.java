...
public class DateOfBirthTest {
    ...
    public void test_constructor001() {
        ...
        DateOfBirth result1 = new DateOfBirth(bluetoothGattCharacteristic);
    ...
    public void test_parcelable001() {
        ...
        DateOfBirth result2 = DateOfBirth.CREATOR.createFromParcel(parcel);
    ...
    public void test_parcelable003() {
        ...
        DateOfBirth result1 = new DateOfBirth(bluetoothGattCharacteristic);
        DateOfBirth result2 = DateOfBirth.CREATOR.createFromByteArray(data);
