...
public class VolumeControlPointAndroid extends VolumeControlPoint implements Parcelable {
     ...
     */
    public static final ByteArrayCreator<VolumeControlPointAndroid> CREATOR = new ByteArrayCreator<VolumeControlPointAndroid>() {
        ...
        public VolumeControlPointAndroid createFromByteArray(@NonNull byte[] values) {
            return new VolumeControlPointAndroid(values);
        }
     ...
     */
    public VolumeControlPointAndroid(@NonNull byte[] values) {
        super(values);
    }
