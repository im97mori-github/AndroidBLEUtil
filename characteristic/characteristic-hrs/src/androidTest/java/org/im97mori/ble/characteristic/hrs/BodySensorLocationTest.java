...
public class BodySensorLocationTest {
    ...
    public void test_constructor001() {
        ...
        BodySensorLocation result1 = new BodySensorLocation(bluetoothGattCharacteristic);
    ...
    public void test_parcelable001() {
        ...
        BodySensorLocation result2 = BodySensorLocation.CREATOR.createFromParcel(parcel);
    ...
    public void test_parcelable003() {
        ...
        BodySensorLocation result1 = new BodySensorLocation(bluetoothGattCharacteristic);
        BodySensorLocation result2 = BodySensorLocation.CREATOR.createFromByteArray(data);
