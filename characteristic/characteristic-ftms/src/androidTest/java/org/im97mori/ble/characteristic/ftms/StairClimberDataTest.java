...
public class StairClimberDataTest {
    ...
    public void test_constructor_00001() {
        ...
        StairClimberData result1 = new StairClimberData(new StairClimberDataPacket[]{StairClimberDataPacket.CREATOR.createFromByteArray(data)});
    ...
    public void test_constructor_00002() {
        ...
        StairClimberData result1 = new StairClimberData(new StairClimberDataPacket[]{StairClimberDataPacket.CREATOR.createFromByteArray(data1), StairClimberDataPacket.CREATOR.createFromByteArray(data2)});
    ...
    public void test_parcelable_1_00001() {
        ...
        StairClimberData result2 = StairClimberData.CREATOR.createFromParcel(parcel);
    ...
    public void test_parcelable_1_00402() {
        ...
        StairClimberDataPacket result1 = new StairClimberDataPacket(bluetoothGattCharacteristic);
        Parcel parcel = Parcel.obtain();
        result1.writeToParcel(parcel, 0);
        parcel.setDataPosition(0);
        StairClimberDataPacket result2 = StairClimberDataPacket.CREATOR.createFromParcel(parcel);
        assertArrayEquals(result1.getFlags(), result2.getFlags());
        assertEquals(result1.getFloors(), result2.getFloors());
        assertEquals(result1.getStepPerMinute(), result2.getStepPerMinute());
        assertEquals(result1.getAverageStepRate(), result2.getAverageStepRate());
