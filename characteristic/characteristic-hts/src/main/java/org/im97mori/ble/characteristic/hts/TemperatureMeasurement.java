...
public class TemperatureMeasurement implements ByteArrayInterface, Parcelable {
     ...
     */
    public static final ByteArrayCreater<TemperatureMeasurement> CREATOR = new ByteArrayCreater<TemperatureMeasurement>() {
        ...
        @Override
        @NonNull
        public TemperatureMeasurement createFromParcel(@NonNull Parcel in) {
            return new TemperatureMeasurement(in);
        }
         ...
         */
        @NonNull
        public TemperatureMeasurement createFromByteArray(@NonNull byte[] values) {
            ...
            return new TemperatureMeasurement(bluetoothGattCharacteristic);
        }
     ...
     */
    public TemperatureMeasurement(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
    ...
    private TemperatureMeasurement(@NonNull Parcel in) {
        mFlags = in.readInt();
     ...
     * @param expect one of {@link #FLAGS_TEMPERATURE_UNITS_CELSIUS}
     *               , {@link #FLAGS_TEMPERATURE_UNITS_FAHRENHEIT}
     *               , {@link #FLAGS_TIME_STAMP_NOT_PRESENT}
     *               , {@link #FLAGS_TIME_STAMP_PRESENT}
     *               , {@link #FLAGS_TEMPERATURE_TYPE_NOT_PRESENT}
     *               , {@link #FLAGS_TEMPERATURE_TYPE_PRESENT}
