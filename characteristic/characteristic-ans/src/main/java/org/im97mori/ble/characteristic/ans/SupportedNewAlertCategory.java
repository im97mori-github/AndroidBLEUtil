...
public class SupportedNewAlertCategory implements ByteArrayInterface, Parcelable {

    /**
     * @see ByteArrayCreater
     */
    public static final ByteArrayCreater<SupportedNewAlertCategory> CREATOR = new ByteArrayCreater<SupportedNewAlertCategory>() {
        ...
        @Override
        @NonNull
        public SupportedNewAlertCategory createFromParcel(@NonNull Parcel in) {
            return new SupportedNewAlertCategory(in);
        }
        ...
        @Override
        @NonNull
        public SupportedNewAlertCategory[] newArray(int size) {
            return new SupportedNewAlertCategory[size];
        }
         ...
         */
        @NonNull
        public SupportedNewAlertCategory createFromByteArray(@NonNull byte[] values) {
            ...
            return new SupportedNewAlertCategory(bluetoothGattCharacteristic);
        }
     ...
     */
    public SupportedNewAlertCategory(@NonNull BluetoothGattCharacteristic bluetoothGattCharacteristic) {
     ...
     * @param in Parcel
     */
    private SupportedNewAlertCategory(@NonNull Parcel in) {
