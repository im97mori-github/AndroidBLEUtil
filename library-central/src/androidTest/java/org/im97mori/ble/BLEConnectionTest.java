...
public class BLEConnectionTest {
    ...
    public void readCharacteristicTaskSuccessTest_001() {
        ...
        MockBLETask task = new MockBLETask() {
            @Override
            public boolean doProcess(@NonNull Message message) {
                MOCK_BLE_CONNECTION.getBLECallback().onCharacteristicReadSuccess(getTaskId(), MockBLEConnection.MOCK_DEVICE, MOCK_UUID, null, MOCK_UUID, null, new byte[0], argument);
                isProccesing.set(false);
                return true;
            }
        };
    ...
    public void writeCharacteristicTaskSuccessTest_001() {
        ...
        MockBLETask task = new MockBLETask() {
            @Override
            public boolean doProcess(@NonNull Message message) {
                MOCK_BLE_CONNECTION.getBLECallback().onCharacteristicWriteSuccess(getTaskId(), MockBLEConnection.MOCK_DEVICE, MOCK_UUID, null, MOCK_UUID, null, new byte[0], argument);
                isProccesing.set(false);
                return true;
            }
        };
    ...
    public void readDescriptorTaskSuccessTest_001() {
        ...
        MockBLETask task = new MockBLETask() {
            @Override
            public boolean doProcess(@NonNull Message message) {
                MOCK_BLE_CONNECTION.getBLECallback().onDescriptorReadSuccess(getTaskId(), MockBLEConnection.MOCK_DEVICE, MOCK_UUID, null, MOCK_UUID, null, MOCK_UUID, new byte[0], argument);
                isProccesing.set(false);
                return true;
            }
        };
