...
public class CharacteristicPresentationFormatTest {
    ...
    public void test_constructor001() {
        ...
        CharacteristicPresentationFormat result = new CharacteristicPresentationFormat(bluetoothGattDescriptor);
    ...
    public void test_constructor004() {
        ...
        Log.d("aaa", String.valueOf(result.getFormat() & CharacteristicPresentationFormat.FORMAT_BOOLEAN));
        Log.d("aaa", String.valueOf((result.getFormat() & CharacteristicPresentationFormat.FORMAT_BOOLEAN) == CharacteristicPresentationFormat.FORMAT_BOOLEAN));
        assertFalse(result.isFormatBoolean());
        assertFalse(result.isFormatUnsigned2BitInteger());
    ...
    public void test_parcelable001() {
        ...
        CharacteristicPresentationFormat result1 = new CharacteristicPresentationFormat(bluetoothGattDescriptor);
        Parcel parcel = Parcel.obtain();
        result1.writeToParcel(parcel, 0);
        parcel.setDataPosition(0);
        CharacteristicPresentationFormat result2 = CharacteristicPresentationFormat.CREATOR.createFromParcel(parcel);
    ...
    public void test_parcelable003() {
        ...
        CharacteristicPresentationFormat result1 = new CharacteristicPresentationFormat(bluetoothGattDescriptor);
        CharacteristicPresentationFormat result2 = CharacteristicPresentationFormat.CREATOR.createFromByteArray(value);
