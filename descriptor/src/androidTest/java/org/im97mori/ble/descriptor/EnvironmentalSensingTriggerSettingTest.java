...
public class EnvironmentalSensingTriggerSettingTest {
    ...
    public void test_constructor001() {
        ...
        EnvironmentalSensingTriggerSetting result = new EnvironmentalSensingTriggerSetting(bluetoothGattDescriptor);
    ...
    public void test_parcelable001() {
        ...
        EnvironmentalSensingTriggerSetting result1 = new EnvironmentalSensingTriggerSetting(bluetoothGattDescriptor);
        Parcel parcel = Parcel.obtain();
        result1.writeToParcel(parcel, 0);
        parcel.setDataPosition(0);
        EnvironmentalSensingTriggerSetting result2 = EnvironmentalSensingTriggerSetting.CREATOR.createFromParcel(parcel);
    ...
    public void test_parcelable003() {
        ...
        EnvironmentalSensingTriggerSetting result1 = new EnvironmentalSensingTriggerSetting(bluetoothGattDescriptor);
        EnvironmentalSensingTriggerSetting result2 = EnvironmentalSensingTriggerSetting.CREATOR.createFromByteArray(value);
