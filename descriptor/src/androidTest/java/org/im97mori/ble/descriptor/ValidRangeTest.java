...
public class ValidRangeTest {
    ...
    public void test_parcelable001() {
        ...
        ValidRange result1 = new ValidRange(bluetoothGattDescriptor);
        Parcel parcel = Parcel.obtain();
        result1.writeToParcel(parcel, 0);
        parcel.setDataPosition(0);
        ValidRange result2 = ValidRange.CREATOR.createFromParcel(parcel);
    ...
    public void test_parcelable003() {
        ...
        ValidRange result1 = new ValidRange(bluetoothGattDescriptor);
        ValidRange result2 = ValidRange.CREATOR.createFromByteArray(value);
