...
public class EnvironmentalSensingServiceMockCallbackBuilderParticulateMatterPm10ConcentrationTest extends AbstractPeripheralTest {
    ...
    public void test_addParticulateMatterPm10Concentration_00002() {
        ...
        ParticulateMatterPm10Concentration originalValue = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));

        final List<BluetoothGattService> bluetoothGattServiceList = new LinkedList<>();
        MOCK_BLE_SERVER_CONNECTION.setCreateAddServiceTaskBluetoothGattServiceList(bluetoothGattServiceList);
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex, originalValue)
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, 0, BluetoothGattDescriptor.PERMISSION_READ, BluetoothGatt.GATT_SUCCESS, 0, new EnvironmentalSensingTriggerSetting(0).getBytes())
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
        ...
        assertEquals(ENVIRONMENTAL_SENSING_SERVICE, bluetoothGattService.getUuid());
        BluetoothGattCharacteristic bluetoothGattCharacteristic = bluetoothGattService.getCharacteristic(PARTICULATE_MATTER_PM10_CONCENTRATION_CHARACTERISTIC);
        assertNotNull(bluetoothGattCharacteristic);
        assertEquals(PARTICULATE_MATTER_PM10_CONCENTRATION_CHARACTERISTIC, bluetoothGattCharacteristic.getUuid());
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_addParticulateMatterPm10Concentration_00003() {
        int characteristicIndex = 0;
        ...
        MOCK_BLE_SERVER_CONNECTION.setCreateAddServiceTaskBluetoothGattServiceList(bluetoothGattServiceList);
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex, originalProperties, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_addParticulateMatterPm10Concentration_00101() {
        int characteristicIndex0 = 0;
        int characteristicIndex1 = 1;
        int originalProperties0 = BluetoothGattCharacteristic.PROPERTY_READ;
        ParticulateMatterPm10Concentration originalValue0 = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        int originalProperties1 = BluetoothGattCharacteristic.PROPERTY_READ;
        ParticulateMatterPm10Concentration originalValue1 = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(2));

        final List<BluetoothGattService> bluetoothGattServiceList = new LinkedList<>();
        MOCK_BLE_SERVER_CONNECTION.setCreateAddServiceTaskBluetoothGattServiceList(bluetoothGattServiceList);
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex0, originalProperties0, BluetoothGatt.GATT_SUCCESS, 0, originalValue0.getBytes())
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex0, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .addParticulateMatterPm10Concentration(characteristicIndex1, originalProperties1, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    public void test_removeParticulateMatterPm10Concentration_00001() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex, originalProperties, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .removeParticulateMatterPm10Concentration(characteristicIndex)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_removeParticulateMatterPm10Concentration_00101() {
        int characteristicIndex0 = 0;
        int characteristicIndex1 = 1;
        int originalProperties0 = BluetoothGattCharacteristic.PROPERTY_READ;
        ParticulateMatterPm10Concentration originalValue0 = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                ...
                .addParticulateMatterPm10Concentration(characteristicIndex1, originalProperties1, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .removeParticulateMatterPm10Concentration(characteristicIndex0)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    public void test_setParticulateMatterPm10ConcentrationEsMeasurement_00001() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex, originalProperties, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex, environmentalSensingMeasurement)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_setParticulateMatterPm10ConcentrationEsMeasurement_00101() {
        int characteristicIndex0 = 0;
        int characteristicIndex1 = 1;
        int originalProperties0 = BluetoothGattCharacteristic.PROPERTY_READ;
        ParticulateMatterPm10Concentration originalValue0 = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex0, originalProperties0, BluetoothGatt.GATT_SUCCESS, 0, originalValue0.getBytes())
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex0, environmentalSensingMeasurement0)
                .addParticulateMatterPm10Concentration(characteristicIndex1, originalProperties1, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex1, environmentalSensingMeasurement1)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    public void test_removeParticulateMatterPm10ConcentrationEsMeasurement_00001() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex, originalProperties, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex, environmentalSensingMeasurement)
                .removeParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_removeParticulateMatterPm10ConcentrationEsMeasurement_00101() {
        int characteristicIndex0 = 0;
        int characteristicIndex1 = 1;
        int originalProperties0 = BluetoothGattCharacteristic.PROPERTY_READ;
        ParticulateMatterPm10Concentration originalValue0 = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        ...
        try {
            new EnvironmentalSensingServiceMockCallback.Builder<>()
                    .addParticulateMatterPm10Concentration(characteristicIndex0, originalProperties0, BluetoothGatt.GATT_SUCCESS, 0, originalValue0.getBytes())
                    .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex0, environmentalSensingMeasurement0)
                    .removeParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex0)
                    .addParticulateMatterPm10Concentration(characteristicIndex1, originalProperties1, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                    .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex1, environmentalSensingMeasurement1)
                    .build();
        ...
        assertEquals("no ES Measurement data:" + PARTICULATE_MATTER_PM10_CONCENTRATION_CHARACTERISTIC, exception.getMessage());
    }
    ...
    public void test_setParticulateMatterPm10ConcentrationEsTriggerSetting_00001() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex, originalValue)
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, descriptorIndex, environmentalSensingTriggerSetting)
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_setParticulateMatterPm10ConcentrationEsTriggerSetting_00003() {
        int characteristicIndex = 0;
        ParticulateMatterPm10Concentration originalValue = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_setParticulateMatterPm10ConcentrationEsTriggerSetting_00004() {
        int characteristicIndex = 0;
        ParticulateMatterPm10Concentration originalValue = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        ...
        MOCK_BLE_SERVER_CONNECTION.setCreateAddServiceTaskBluetoothGattServiceList(bluetoothGattServiceList);
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex, BluetoothGattDescriptor.PERMISSION_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, descriptorIndex, environmentalSensingTriggerSetting)
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_setParticulateMatterPm10ConcentrationEsTriggerSetting_00101() {
        int characteristicIndex = 0;
        ParticulateMatterPm10Concentration originalValue = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex, originalValue)
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, descriptorIndex0, environmentalSensingTriggerSetting0)
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, descriptorIndex2, environmentalSensingTriggerSetting2)
                .setParticulateMatterPm10ConcentrationEsConfiguration(characteristicIndex, new EnvironmentalSensingConfiguration(0))
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_setParticulateMatterPm10ConcentrationEsTriggerSetting_00102() {
        int characteristicIndex = 0;
        ParticulateMatterPm10Concentration originalValue = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        int descriptorIndex0 = 0;
        EnvironmentalSensingTriggerSetting environmentalSensingTriggerSetting0 = new EnvironmentalSensingTriggerSetting(1);
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex, originalValue)
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, descriptorIndex0, environmentalSensingTriggerSetting0)
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, descriptorIndex1, environmentalSensingTriggerSetting1)
                .setParticulateMatterPm10ConcentrationEsConfiguration(characteristicIndex, new EnvironmentalSensingConfiguration(0))
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_setParticulateMatterPm10ConcentrationEsTriggerSetting_00103() {
        int characteristicIndex = 0;
        ParticulateMatterPm10Concentration originalValue = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        int descriptorIndex1 = 1;
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_setParticulateMatterPm10ConcentrationEsTriggerSetting_00104() {
        int characteristicIndex = 0;
        ParticulateMatterPm10Concentration originalValue = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        int descriptorIndex0 = 0;
    ...
    public void test_removeParticulateMatterPm10ConcentrationEsTriggerSetting_00001() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex, BluetoothGattDescriptor.PERMISSION_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, descriptorIndex, environmentalSensingTriggerSetting)
                .removeParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, descriptorIndex)
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_removeParticulateMatterPm10ConcentrationEsTriggerSetting_00002() {
        int characteristicIndex = 0;
        ParticulateMatterPm10Concentration originalValue = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        int descriptorIndex = 1;
        EnvironmentalSensingTriggerSetting environmentalSensingTriggerSetting = new EnvironmentalSensingTriggerSetting(1);
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_removeParticulateMatterPm10ConcentrationEsTriggerSetting_00003() {
        int characteristicIndex = 0;
        ParticulateMatterPm10Concentration originalValue = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        int descriptorIndex = 2;
        EnvironmentalSensingTriggerSetting environmentalSensingTriggerSetting = new EnvironmentalSensingTriggerSetting(1);
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_removeParticulateMatterPm10ConcentrationEsTriggerSetting_00004() {
        int characteristicIndex = 0;
        ParticulateMatterPm10Concentration originalValue = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        int descriptorIndex = 3;
        EnvironmentalSensingTriggerSetting environmentalSensingTriggerSetting = new EnvironmentalSensingTriggerSetting(1);
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_removeParticulateMatterPm10ConcentrationEsTriggerSetting_00101() {
        int characteristicIndex = 0;
        ParticulateMatterPm10Concentration originalValue = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        int descriptorIndex0 = 0;
        EnvironmentalSensingTriggerSetting environmentalSensingTriggerSetting0 = new EnvironmentalSensingTriggerSetting(1);
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex, BluetoothGattDescriptor.PERMISSION_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, descriptorIndex0, environmentalSensingTriggerSetting0)
                .removeParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, descriptorIndex0)
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, descriptorIndex2, environmentalSensingTriggerSetting2)
                .removeParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, descriptorIndex2)
                .setParticulateMatterPm10ConcentrationEsConfiguration(characteristicIndex, new EnvironmentalSensingConfiguration(0))
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_removeParticulateMatterPm10ConcentrationEsTriggerSetting_00102() {
        int characteristicIndex = 0;
        ParticulateMatterPm10Concentration originalValue = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        int descriptorIndex0 = 0;
        EnvironmentalSensingTriggerSetting environmentalSensingTriggerSetting0 = new EnvironmentalSensingTriggerSetting(1);
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                ...
                .removeParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, descriptorIndex0)
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, descriptorIndex1, environmentalSensingTriggerSetting1)
                .removeParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, descriptorIndex1)
                .setParticulateMatterPm10ConcentrationEsConfiguration(characteristicIndex, new EnvironmentalSensingConfiguration(0))
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_removeParticulateMatterPm10ConcentrationEsTriggerSetting_00103() {
        int characteristicIndex = 0;
        ParticulateMatterPm10Concentration originalValue = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        int descriptorIndex1 = 1;
        EnvironmentalSensingTriggerSetting environmentalSensingTriggerSetting1 = new EnvironmentalSensingTriggerSetting(1);
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_removeParticulateMatterPm10ConcentrationEsTriggerSetting_00104() {
        int characteristicIndex = 0;
        ParticulateMatterPm10Concentration originalValue = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        int descriptorIndex0 = 0;
        EnvironmentalSensingTriggerSetting environmentalSensingTriggerSetting0 = new EnvironmentalSensingTriggerSetting(0);
    ...
    public void test_setParticulateMatterPm10ConcentrationEsConfiguration_00001() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex, originalValue)
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, 0, environmentalSensingTriggerSetting0)
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, 1, environmentalSensingTriggerSetting1)
                .setParticulateMatterPm10ConcentrationEsConfiguration(characteristicIndex, environmentalSensingConfiguration)
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
    ...
    public void test_setParticulateMatterPm10ConcentrationEsConfiguration_00002() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                ...
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, 0, environmentalSensingTriggerSetting0)
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, 1, environmentalSensingTriggerSetting1)
                .setParticulateMatterPm10ConcentrationEsConfiguration(characteristicIndex, descriptorPermission, BluetoothGatt.GATT_SUCCESS, 0, environmentalSensingConfiguration.getBytes())
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_setParticulateMatterPm10ConcentrationEsConfiguration_00101() {
        int characteristicIndex0 = 0;
        ParticulateMatterPm10Concentration originalValue0 = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        ...
        MOCK_BLE_SERVER_CONNECTION.setCreateAddServiceTaskBluetoothGattServiceList(bluetoothGattServiceList);
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex0, originalValue0)
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex0, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex0, 0, new EnvironmentalSensingTriggerSetting(1))
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex0, 1, new EnvironmentalSensingTriggerSetting(2))
                .setParticulateMatterPm10ConcentrationEsConfiguration(characteristicIndex0, environmentalSensingConfiguration0)
                .addParticulateMatterPm10Concentration(characteristicIndex1, originalValue1)
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 1, 0, 0, 0, 0))
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex1, 0, new EnvironmentalSensingTriggerSetting(3))
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex1, 1, new EnvironmentalSensingTriggerSetting(4))
                .setParticulateMatterPm10ConcentrationEsConfiguration(characteristicIndex1, environmentalSensingConfiguration1)
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_setParticulateMatterPm10ConcentrationEsConfiguration_00102() {
        int characteristicIndex0 = 0;
        ParticulateMatterPm10Concentration originalValue0 = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        EnvironmentalSensingConfiguration environmentalSensingConfiguration0 = new EnvironmentalSensingConfiguration(EnvironmentalSensingConfiguration.TRIGGER_LOGIC_VALUE_BOOLAEN_AND);
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                ...
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex0, 0, new EnvironmentalSensingTriggerSetting(1))
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex0, 1, new EnvironmentalSensingTriggerSetting(2))
                .setParticulateMatterPm10ConcentrationEsConfiguration(characteristicIndex0, descriptorPermission, BluetoothGatt.GATT_SUCCESS, 0, environmentalSensingConfiguration0.getBytes())
                .addParticulateMatterPm10Concentration(characteristicIndex1, originalValue1)
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 1, 0, 0, 0, 0))
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex1, 0, new EnvironmentalSensingTriggerSetting(3))
                .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex1, 1, new EnvironmentalSensingTriggerSetting(4))
                .setParticulateMatterPm10ConcentrationEsConfiguration(characteristicIndex1, descriptorPermission, BluetoothGatt.GATT_SUCCESS, 0, environmentalSensingConfiguration1.getBytes())
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
    ...
    public void test_removeParticulateMatterPm10ConcentrationEsConfiguration_00001() {
        ...
        try {
            new EnvironmentalSensingServiceMockCallback.Builder<>()
                    ...
                    .setParticulateMatterPm10ConcentrationEsTriggerSetting(characteristicIndex, descriptorIndex1, environmentalSensingTriggerSetting1)
                    .setParticulateMatterPm10ConcentrationEsConfiguration(characteristicIndex, environmentalSensingConfiguration)
                    .removeParticulateMatterPm10ConcentrationEsConfiguration(characteristicIndex)
                    .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                    .build();
        } catch (RuntimeException e) {
            exception = e;
        ...
        assertNotNull(exception);
        assertEquals("no ES Configuration data:" + PARTICULATE_MATTER_PM10_CONCENTRATION_CHARACTERISTIC, exception.getMessage());
    }

    @Test
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_removeParticulateMatterPm10ConcentrationEsConfiguration_00101() {
        int characteristicIndex0 = 0;
        ParticulateMatterPm10Concentration originalValue0 = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        EnvironmentalSensingConfiguration environmentalSensingConfiguration0 = new EnvironmentalSensingConfiguration(EnvironmentalSensingConfiguration.TRIGGER_LOGIC_VALUE_BOOLAEN_AND);
    ...
    public void test_setParticulateMatterPm10ConcentrationCharacteristicUserDescription_00001() {
        ...
        MOCK_BLE_SERVER_CONNECTION.setCreateAddServiceTaskBluetoothGattServiceList(bluetoothGattServiceList);
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setParticulateMatterPm10ConcentrationCharacteristicUserDescription(characteristicIndex, characteristicUserDescription)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    public void test_setParticulateMatterPm10ConcentrationCharacteristicUserDescription_00002() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setParticulateMatterPm10ConcentrationCharacteristicUserDescription(characteristicIndex, BluetoothGatt.GATT_SUCCESS, 0, characteristicUserDescription.getBytes())
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    public void test_setParticulateMatterPm10ConcentrationCharacteristicUserDescription_00101() {
        ...
        MOCK_BLE_SERVER_CONNECTION.setCreateAddServiceTaskBluetoothGattServiceList(bluetoothGattServiceList);
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex0, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue0.getBytes())
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex0, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .setParticulateMatterPm10ConcentrationCharacteristicUserDescription(characteristicIndex0, characteristicUserDescription0)
                .addParticulateMatterPm10Concentration(characteristicIndex1, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 1, 0, 0, 0, 0))
                .setParticulateMatterPm10ConcentrationCharacteristicUserDescription(characteristicIndex1, characteristicUserDescription1)
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
    ...
    public void test_setParticulateMatterPm10ConcentrationCharacteristicUserDescription_00102() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex0, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue0.getBytes())
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex0, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .setParticulateMatterPm10ConcentrationCharacteristicUserDescription(characteristicIndex0, BluetoothGatt.GATT_SUCCESS, 0, characteristicUserDescription0.getBytes())
                .addParticulateMatterPm10Concentration(characteristicIndex1, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 1, 0, 0, 0, 0))
                .setParticulateMatterPm10ConcentrationCharacteristicUserDescription(characteristicIndex1, BluetoothGatt.GATT_SUCCESS, 0, characteristicUserDescription1.getBytes())
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    public void test_removeParticulateMatterPm10ConcentrationCharacteristicUserDescription_00001() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setParticulateMatterPm10ConcentrationCharacteristicUserDescription(characteristicIndex, characteristicUserDescription)
                .removeParticulateMatterPm10ConcentrationCharacteristicUserDescription(characteristicIndex)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_removeParticulateMatterPm10ConcentrationCharacteristicUserDescription_00101() {
        int characteristicIndex0 = 0;
        ParticulateMatterPm10Concentration originalValue0 = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        CharacteristicUserDescription characteristicUserDescription0 = new CharacteristicUserDescription(new byte[]{0});
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                ...
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex0, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .setParticulateMatterPm10ConcentrationCharacteristicUserDescription(characteristicIndex0, characteristicUserDescription0)
                .removeParticulateMatterPm10ConcentrationCharacteristicUserDescription(characteristicIndex0)
                .addParticulateMatterPm10Concentration(characteristicIndex1, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 1, 0, 0, 0, 0))
                .setParticulateMatterPm10ConcentrationCharacteristicUserDescription(characteristicIndex1, characteristicUserDescription1)
                .removeParticulateMatterPm10ConcentrationCharacteristicUserDescription(characteristicIndex1)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    public void test_setParticulateMatterPm10ConcentrationValidRange_00001() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setParticulateMatterPm10ConcentrationValidRange(characteristicIndex, validRange)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    public void test_setParticulateMatterPm10ConcentrationValidRange_00002() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setParticulateMatterPm10ConcentrationValidRange(characteristicIndex, BluetoothGatt.GATT_SUCCESS, 0, validRange.getBytes())
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_setParticulateMatterPm10ConcentrationValidRange_00101() {
        int characteristicIndex0 = 0;
        ParticulateMatterPm10Concentration originalValue0 = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex0, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue0.getBytes())
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex0, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .setParticulateMatterPm10ConcentrationValidRange(characteristicIndex0, validRange0)
                .addParticulateMatterPm10Concentration(characteristicIndex1, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 1, 0, 0, 0, 0))
                .setParticulateMatterPm10ConcentrationValidRange(characteristicIndex1, validRange1)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_setParticulateMatterPm10ConcentrationValidRange_00102() {
        int characteristicIndex0 = 0;
        ParticulateMatterPm10Concentration originalValue0 = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        ValidRange validRange0 = new ValidRange(new byte[]{0}, new byte[]{1});
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex0, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue0.getBytes())
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex0, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .setParticulateMatterPm10ConcentrationValidRange(characteristicIndex0, BluetoothGatt.GATT_SUCCESS, 0, validRange0.getBytes())
                .addParticulateMatterPm10Concentration(characteristicIndex1, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 1, 0, 0, 0, 0))
                .setParticulateMatterPm10ConcentrationValidRange(characteristicIndex1, BluetoothGatt.GATT_SUCCESS, 0, validRange1.getBytes())
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    public void test_removeParticulateMatterPm10ConcentrationValidRange_00001() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addParticulateMatterPm10Concentration(characteristicIndex, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setParticulateMatterPm10ConcentrationValidRange(characteristicIndex, validRange)
                .removeParticulateMatterPm10ConcentrationValidRange(characteristicIndex)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    @RequiresDevice
    @SdkSuppress(minSdkVersion = Build.VERSION_CODES.LOLLIPOP)
    public void test_removeParticulateMatterPm10ConcentrationValidRange_00101() {
        int characteristicIndex0 = 0;
        ParticulateMatterPm10Concentration originalValue0 = new ParticulateMatterPm10Concentration(new IEEE_11073_20601_SFLOAT(1));
        ValidRange validRange0 = new ValidRange(new byte[]{0}, new byte[]{1});
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                ...
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex0, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .setParticulateMatterPm10ConcentrationValidRange(characteristicIndex0, validRange0)
                .removeParticulateMatterPm10ConcentrationValidRange(characteristicIndex0)
                .addParticulateMatterPm10Concentration(characteristicIndex1, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                .setParticulateMatterPm10ConcentrationEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 1, 0, 0, 0, 0))
                .setParticulateMatterPm10ConcentrationValidRange(characteristicIndex1, validRange1)
                .removeParticulateMatterPm10ConcentrationValidRange(characteristicIndex1)
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
