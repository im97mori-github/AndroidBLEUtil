...
public class EnvironmentalSensingServiceMockCallbackBuilderTest_MagneticFluxDensity3D extends AbstractPeripherallTest {
    ...
    public void test_addMagneticFluxDensity3D_00002() {
        ...
        MagneticFluxDensity3D originalValue = new MagneticFluxDensity3D(1, 11, 111);

        final List<BluetoothGattService> bluetoothGattServiceList = new LinkedList<>();
        MOCK_BLE_SERVER_CONNECTION.setCreateAddServiceTaskBluetoothGattServiceList(bluetoothGattServiceList);
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex, originalValue)
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, 0, BluetoothGattDescriptor.PERMISSION_READ, BluetoothGatt.GATT_SUCCESS, 0, new EnvironmentalSensingTriggerSetting(0).getBytes())
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
        ...
        assertEquals(ENVIRONMENTAL_SENSING_SERVICE, bluetoothGattService.getUuid());
        BluetoothGattCharacteristic bluetoothGattCharacteristic = bluetoothGattService.getCharacteristic(MAGNETIC_FLUX_DENSITY_3D_CHARACTERISTIC);
        assertNotNull(bluetoothGattCharacteristic);
        assertEquals(MAGNETIC_FLUX_DENSITY_3D_CHARACTERISTIC, bluetoothGattCharacteristic.getUuid());
    ...
    @Test
    public void test_addMagneticFluxDensity3D_00003() {
        int characteristicIndex = 0;
        ...
        MOCK_BLE_SERVER_CONNECTION.setCreateAddServiceTaskBluetoothGattServiceList(bluetoothGattServiceList);
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex, originalProperties, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    @Test
    public void test_addMagneticFluxDensity3D_00101() {
        int characteristicIndex0 = 0;
        int characteristicIndex1 = 1;
        int originalProperties0 = BluetoothGattCharacteristic.PROPERTY_READ;
        MagneticFluxDensity3D originalValue0 = new MagneticFluxDensity3D(1, 11, 111);
        int originalProperties1 = BluetoothGattCharacteristic.PROPERTY_READ;
        MagneticFluxDensity3D originalValue1 = new MagneticFluxDensity3D(2, 22, 222);

        final List<BluetoothGattService> bluetoothGattServiceList = new LinkedList<>();
        MOCK_BLE_SERVER_CONNECTION.setCreateAddServiceTaskBluetoothGattServiceList(bluetoothGattServiceList);
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex0, originalProperties0, BluetoothGatt.GATT_SUCCESS, 0, originalValue0.getBytes())
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex0, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .addMagneticFluxDensity3D(characteristicIndex1, originalProperties1, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    public void test_removeMagneticFluxDensity3D_00001() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex, originalProperties, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .removeMagneticFluxDensity3D(characteristicIndex)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    @Test
    public void test_removeMagneticFluxDensity3D_00101() {
        int characteristicIndex0 = 0;
        int characteristicIndex1 = 1;
        int originalProperties0 = BluetoothGattCharacteristic.PROPERTY_READ;
        MagneticFluxDensity3D originalValue0 = new MagneticFluxDensity3D(1, 11, 111);
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                ...
                .addMagneticFluxDensity3D(characteristicIndex1, originalProperties1, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .removeMagneticFluxDensity3D(characteristicIndex0)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    public void test_setMagneticFluxDensity3DEsMeasurement_00001() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex, originalProperties, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex, environmentalSensingMeasurement)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    @Test
    public void test_setMagneticFluxDensity3DEsMeasurement_00101() {
        int characteristicIndex0 = 0;
        int characteristicIndex1 = 1;
        int originalProperties0 = BluetoothGattCharacteristic.PROPERTY_READ;
        MagneticFluxDensity3D originalValue0 = new MagneticFluxDensity3D(1, 11, 111);
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex0, originalProperties0, BluetoothGatt.GATT_SUCCESS, 0, originalValue0.getBytes())
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex0, environmentalSensingMeasurement0)
                .addMagneticFluxDensity3D(characteristicIndex1, originalProperties1, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex1, environmentalSensingMeasurement1)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    public void test_removeMagneticFluxDensity3DEsMeasurement_00001() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex, originalProperties, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex, environmentalSensingMeasurement)
                .removeMagneticFluxDensity3DEsMeasurement(characteristicIndex)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    @Test
    public void test_removeMagneticFluxDensity3DEsMeasurement_00101() {
        int characteristicIndex0 = 0;
        int characteristicIndex1 = 1;
        int originalProperties0 = BluetoothGattCharacteristic.PROPERTY_READ;
        MagneticFluxDensity3D originalValue0 = new MagneticFluxDensity3D(1, 11, 111);
        ...
        try {
            new EnvironmentalSensingServiceMockCallback.Builder<>()
                    .addMagneticFluxDensity3D(characteristicIndex0, originalProperties0, BluetoothGatt.GATT_SUCCESS, 0, originalValue0.getBytes())
                    .setMagneticFluxDensity3DEsMeasurement(characteristicIndex0, environmentalSensingMeasurement0)
                    .removeMagneticFluxDensity3DEsMeasurement(characteristicIndex0)
                    .addMagneticFluxDensity3D(characteristicIndex1, originalProperties1, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                    .setMagneticFluxDensity3DEsMeasurement(characteristicIndex1, environmentalSensingMeasurement1)
                    .build();
    ...
    public void test_setMagneticFluxDensity3DEsTriggerSetting_00001() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex, originalValue)
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, descriptorIndex, environmentalSensingTriggerSetting)
    ...
    @Test
    public void test_setMagneticFluxDensity3DEsTriggerSetting_00003() {
        int characteristicIndex = 0;
        MagneticFluxDensity3D originalValue = new MagneticFluxDensity3D(1, 11, 111);
    ...
    @Test
    public void test_setMagneticFluxDensity3DEsTriggerSetting_00004() {
        int characteristicIndex = 0;
        MagneticFluxDensity3D originalValue = new MagneticFluxDensity3D(1, 11, 111);
        ...
        MOCK_BLE_SERVER_CONNECTION.setCreateAddServiceTaskBluetoothGattServiceList(bluetoothGattServiceList);
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex, BluetoothGattDescriptor.PERMISSION_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, descriptorIndex, environmentalSensingTriggerSetting)
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
    ...
    @Test
    public void test_setMagneticFluxDensity3DEsTriggerSetting_00101() {
        int characteristicIndex = 0;
        MagneticFluxDensity3D originalValue = new MagneticFluxDensity3D(1, 11, 111);
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex, originalValue)
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, descriptorIndex0, environmentalSensingTriggerSetting0)
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, descriptorIndex2, environmentalSensingTriggerSetting2)
                .setMagneticFluxDensity3DEsConfiguration(characteristicIndex, new EnvironmentalSensingConfiguration(0))
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
    ...
    @Test
    public void test_setMagneticFluxDensity3DEsTriggerSetting_00102() {
        int characteristicIndex = 0;
        MagneticFluxDensity3D originalValue = new MagneticFluxDensity3D(1, 11, 111);
        int descriptorIndex0 = 0;
        EnvironmentalSensingTriggerSetting environmentalSensingTriggerSetting0 = new EnvironmentalSensingTriggerSetting(1);
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex, originalValue)
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, descriptorIndex0, environmentalSensingTriggerSetting0)
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, descriptorIndex1, environmentalSensingTriggerSetting1)
                .setMagneticFluxDensity3DEsConfiguration(characteristicIndex, new EnvironmentalSensingConfiguration(0))
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
    ...
    @Test
    public void test_setMagneticFluxDensity3DEsTriggerSetting_00103() {
        int characteristicIndex = 0;
        MagneticFluxDensity3D originalValue = new MagneticFluxDensity3D(1, 11, 111);
        int descriptorIndex1 = 1;
    ...
    @Test
    public void test_setMagneticFluxDensity3DEsTriggerSetting_00104() {
        int characteristicIndex = 0;
        MagneticFluxDensity3D originalValue = new MagneticFluxDensity3D(1, 11, 111);
        int descriptorIndex0 = 0;
    ...
    public void test_removeMagneticFluxDensity3DEsTriggerSetting_00001() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex, BluetoothGattDescriptor.PERMISSION_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, descriptorIndex, environmentalSensingTriggerSetting)
                .removeMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, descriptorIndex)
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
    ...
    @Test
    public void test_removeMagneticFluxDensity3DEsTriggerSetting_00002() {
        int characteristicIndex = 0;
        MagneticFluxDensity3D originalValue = new MagneticFluxDensity3D(1, 11, 111);
        int descriptorIndex = 1;
        EnvironmentalSensingTriggerSetting environmentalSensingTriggerSetting = new EnvironmentalSensingTriggerSetting(1);
    ...
    @Test
    public void test_removeMagneticFluxDensity3DEsTriggerSetting_00003() {
        int characteristicIndex = 0;
        MagneticFluxDensity3D originalValue = new MagneticFluxDensity3D(1, 11, 111);
        int descriptorIndex = 2;
        EnvironmentalSensingTriggerSetting environmentalSensingTriggerSetting = new EnvironmentalSensingTriggerSetting(1);
    ...
    @Test
    public void test_removeMagneticFluxDensity3DEsTriggerSetting_00004() {
        int characteristicIndex = 0;
        MagneticFluxDensity3D originalValue = new MagneticFluxDensity3D(1, 11, 111);
        int descriptorIndex = 3;
        EnvironmentalSensingTriggerSetting environmentalSensingTriggerSetting = new EnvironmentalSensingTriggerSetting(1);
    ...
    @Test
    public void test_removeMagneticFluxDensity3DEsTriggerSetting_00101() {
        int characteristicIndex = 0;
        MagneticFluxDensity3D originalValue = new MagneticFluxDensity3D(1, 11, 111);
        int descriptorIndex0 = 0;
        EnvironmentalSensingTriggerSetting environmentalSensingTriggerSetting0 = new EnvironmentalSensingTriggerSetting(1);
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex, BluetoothGattDescriptor.PERMISSION_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, descriptorIndex0, environmentalSensingTriggerSetting0)
                .removeMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, descriptorIndex0)
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, descriptorIndex2, environmentalSensingTriggerSetting2)
                .removeMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, descriptorIndex2)
                .setMagneticFluxDensity3DEsConfiguration(characteristicIndex, new EnvironmentalSensingConfiguration(0))
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
    ...
    @Test
    public void test_removeMagneticFluxDensity3DEsTriggerSetting_00102() {
        int characteristicIndex = 0;
        MagneticFluxDensity3D originalValue = new MagneticFluxDensity3D(1, 11, 111);
        int descriptorIndex0 = 0;
        EnvironmentalSensingTriggerSetting environmentalSensingTriggerSetting0 = new EnvironmentalSensingTriggerSetting(1);
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                ...
                .removeMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, descriptorIndex0)
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, descriptorIndex1, environmentalSensingTriggerSetting1)
                .removeMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, descriptorIndex1)
                .setMagneticFluxDensity3DEsConfiguration(characteristicIndex, new EnvironmentalSensingConfiguration(0))
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
    ...
    @Test
    public void test_removeMagneticFluxDensity3DEsTriggerSetting_00103() {
        int characteristicIndex = 0;
        MagneticFluxDensity3D originalValue = new MagneticFluxDensity3D(1, 11, 111);
        int descriptorIndex1 = 1;
        EnvironmentalSensingTriggerSetting environmentalSensingTriggerSetting1 = new EnvironmentalSensingTriggerSetting(1);
    ...
    @Test
    public void test_removeMagneticFluxDensity3DEsTriggerSetting_00104() {
        int characteristicIndex = 0;
        MagneticFluxDensity3D originalValue = new MagneticFluxDensity3D(1, 11, 111);
        int descriptorIndex0 = 0;
        EnvironmentalSensingTriggerSetting environmentalSensingTriggerSetting0 = new EnvironmentalSensingTriggerSetting(0);
    ...
    public void test_setMagneticFluxDensity3DEsConfiguration_00001() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex, originalValue)
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, 0, environmentalSensingTriggerSetting0)
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, 1, environmentalSensingTriggerSetting1)
                .setMagneticFluxDensity3DEsConfiguration(characteristicIndex, environmentalSensingConfiguration)
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
    ...
    public void test_setMagneticFluxDensity3DEsConfiguration_00002() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                ...
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, 0, environmentalSensingTriggerSetting0)
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, 1, environmentalSensingTriggerSetting1)
                .setMagneticFluxDensity3DEsConfiguration(characteristicIndex, descriptorPermission, BluetoothGatt.GATT_SUCCESS, 0, environmentalSensingConfiguration.getBytes())
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
    ...
    @Test
    public void test_setMagneticFluxDensity3DEsConfiguration_00101() {
        int characteristicIndex0 = 0;
        MagneticFluxDensity3D originalValue0 = new MagneticFluxDensity3D(1, 11, 111);
        ...
        MOCK_BLE_SERVER_CONNECTION.setCreateAddServiceTaskBluetoothGattServiceList(bluetoothGattServiceList);
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex0, originalValue0)
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex0, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex0, 0, new EnvironmentalSensingTriggerSetting(1))
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex0, 1, new EnvironmentalSensingTriggerSetting(2))
                .setMagneticFluxDensity3DEsConfiguration(characteristicIndex0, environmentalSensingConfiguration0)
                .addMagneticFluxDensity3D(characteristicIndex1, originalValue1)
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 1, 0, 0, 0, 0))
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex1, 0, new EnvironmentalSensingTriggerSetting(3))
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex1, 1, new EnvironmentalSensingTriggerSetting(4))
                .setMagneticFluxDensity3DEsConfiguration(characteristicIndex1, environmentalSensingConfiguration1)
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
    ...
    @Test
    public void test_setMagneticFluxDensity3DEsConfiguration_00102() {
        int characteristicIndex0 = 0;
        MagneticFluxDensity3D originalValue0 = new MagneticFluxDensity3D(1, 11, 111);
        EnvironmentalSensingConfiguration environmentalSensingConfiguration0 = new EnvironmentalSensingConfiguration(EnvironmentalSensingConfiguration.TRIGGER_LOGIC_VALUE_BOOLAEN_AND);
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                ...
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex0, 0, new EnvironmentalSensingTriggerSetting(1))
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex0, 1, new EnvironmentalSensingTriggerSetting(2))
                .setMagneticFluxDensity3DEsConfiguration(characteristicIndex0, descriptorPermission, BluetoothGatt.GATT_SUCCESS, 0, environmentalSensingConfiguration0.getBytes())
                .addMagneticFluxDensity3D(characteristicIndex1, originalValue1)
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 1, 0, 0, 0, 0))
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex1, 0, new EnvironmentalSensingTriggerSetting(3))
                .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex1, 1, new EnvironmentalSensingTriggerSetting(4))
                .setMagneticFluxDensity3DEsConfiguration(characteristicIndex1, descriptorPermission, BluetoothGatt.GATT_SUCCESS, 0, environmentalSensingConfiguration1.getBytes())
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
    ...
    public void test_removeMagneticFluxDensity3DEsConfiguration_00001() {
        ...
        try {
            new EnvironmentalSensingServiceMockCallback.Builder<>()
                    ...
                    .setMagneticFluxDensity3DEsTriggerSetting(characteristicIndex, descriptorIndex1, environmentalSensingTriggerSetting1)
                    .setMagneticFluxDensity3DEsConfiguration(characteristicIndex, environmentalSensingConfiguration)
                    .removeMagneticFluxDensity3DEsConfiguration(characteristicIndex)
                    .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                    .build();
        } catch (RuntimeException e) {
            exception = e;
    ...
    @Test
    public void test_removeMagneticFluxDensity3DEsConfiguration_00101() {
        int characteristicIndex0 = 0;
        MagneticFluxDensity3D originalValue0 = new MagneticFluxDensity3D(1, 11, 111);
        EnvironmentalSensingConfiguration environmentalSensingConfiguration0 = new EnvironmentalSensingConfiguration(EnvironmentalSensingConfiguration.TRIGGER_LOGIC_VALUE_BOOLAEN_AND);
    ...
    public void test_setMagneticFluxDensity3DCharacteristicUserDescription_00001() {
        ...
        MOCK_BLE_SERVER_CONNECTION.setCreateAddServiceTaskBluetoothGattServiceList(bluetoothGattServiceList);
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setMagneticFluxDensity3DCharacteristicUserDescription(characteristicIndex, characteristicUserDescription)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    public void test_setMagneticFluxDensity3DCharacteristicUserDescription_00002() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setMagneticFluxDensity3DCharacteristicUserDescription(characteristicIndex, BluetoothGatt.GATT_SUCCESS, 0, characteristicUserDescription.getBytes())
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    public void test_setMagneticFluxDensity3DCharacteristicUserDescription_00101() {
        ...
        MOCK_BLE_SERVER_CONNECTION.setCreateAddServiceTaskBluetoothGattServiceList(bluetoothGattServiceList);
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex0, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue0.getBytes())
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex0, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .setMagneticFluxDensity3DCharacteristicUserDescription(characteristicIndex0, characteristicUserDescription0)
                .addMagneticFluxDensity3D(characteristicIndex1, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 1, 0, 0, 0, 0))
                .setMagneticFluxDensity3DCharacteristicUserDescription(characteristicIndex1, characteristicUserDescription1)
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
    ...
    public void test_setMagneticFluxDensity3DCharacteristicUserDescription_00102() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex0, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue0.getBytes())
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex0, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .setMagneticFluxDensity3DCharacteristicUserDescription(characteristicIndex0, BluetoothGatt.GATT_SUCCESS, 0, characteristicUserDescription0.getBytes())
                .addMagneticFluxDensity3D(characteristicIndex1, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 1, 0, 0, 0, 0))
                .setMagneticFluxDensity3DCharacteristicUserDescription(characteristicIndex1, BluetoothGatt.GATT_SUCCESS, 0, characteristicUserDescription1.getBytes())
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    public void test_removeMagneticFluxDensity3DCharacteristicUserDescription_00001() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setMagneticFluxDensity3DCharacteristicUserDescription(characteristicIndex, characteristicUserDescription)
                .removeMagneticFluxDensity3DCharacteristicUserDescription(characteristicIndex)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    @Test
    public void test_removeMagneticFluxDensity3DCharacteristicUserDescription_00101() {
        int characteristicIndex0 = 0;
        MagneticFluxDensity3D originalValue0 = new MagneticFluxDensity3D(1, 11, 111);
        CharacteristicUserDescription characteristicUserDescription0 = new CharacteristicUserDescription(new byte[]{0});
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                ...
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex0, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .setMagneticFluxDensity3DCharacteristicUserDescription(characteristicIndex0, characteristicUserDescription0)
                .removeMagneticFluxDensity3DCharacteristicUserDescription(characteristicIndex0)
                .addMagneticFluxDensity3D(characteristicIndex1, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 1, 0, 0, 0, 0))
                .setMagneticFluxDensity3DCharacteristicUserDescription(characteristicIndex1, characteristicUserDescription1)
                .removeMagneticFluxDensity3DCharacteristicUserDescription(characteristicIndex1)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    public void test_setMagneticFluxDensity3DValidRange_00001() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setMagneticFluxDensity3DValidRange(characteristicIndex, validRange)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    public void test_setMagneticFluxDensity3DValidRange_00002() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setMagneticFluxDensity3DValidRange(characteristicIndex, BluetoothGatt.GATT_SUCCESS, 0, validRange.getBytes())
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    @Test
    public void test_setMagneticFluxDensity3DValidRange_00101() {
        int characteristicIndex0 = 0;
        MagneticFluxDensity3D originalValue0 = new MagneticFluxDensity3D(1, 11, 111);
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex0, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue0.getBytes())
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex0, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .setMagneticFluxDensity3DValidRange(characteristicIndex0, validRange0)
                .addMagneticFluxDensity3D(characteristicIndex1, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 1, 0, 0, 0, 0))
                .setMagneticFluxDensity3DValidRange(characteristicIndex1, validRange1)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    @Test
    public void test_setMagneticFluxDensity3DValidRange_00102() {
        int characteristicIndex0 = 0;
        MagneticFluxDensity3D originalValue0 = new MagneticFluxDensity3D(1, 11, 111);
        ValidRange validRange0 = new ValidRange(new byte[]{0}, new byte[]{1});
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex0, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue0.getBytes())
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex0, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .setMagneticFluxDensity3DValidRange(characteristicIndex0, BluetoothGatt.GATT_SUCCESS, 0, validRange0.getBytes())
                .addMagneticFluxDensity3D(characteristicIndex1, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 1, 0, 0, 0, 0))
                .setMagneticFluxDensity3DValidRange(characteristicIndex1, BluetoothGatt.GATT_SUCCESS, 0, validRange1.getBytes())
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    public void test_removeMagneticFluxDensity3DValidRange_00001() {
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                .addMagneticFluxDensity3D(characteristicIndex, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue.getBytes())
                .setMagneticFluxDensity3DValidRange(characteristicIndex, validRange)
                .removeMagneticFluxDensity3DValidRange(characteristicIndex)
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
        BluetoothGattService bluetoothGattService = bluetoothGattServiceList.get(0);
    ...
    @Test
    public void test_removeMagneticFluxDensity3DValidRange_00101() {
        int characteristicIndex0 = 0;
        MagneticFluxDensity3D originalValue0 = new MagneticFluxDensity3D(1, 11, 111);
        ValidRange validRange0 = new ValidRange(new byte[]{0}, new byte[]{1});
        ...
        EnvironmentalSensingServiceMockCallback callback = new EnvironmentalSensingServiceMockCallback.Builder<>()
                ...
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex0, new EnvironmentalSensingMeasurement(new byte[2], 0, 0, 0, 0, 0))
                .setMagneticFluxDensity3DValidRange(characteristicIndex0, validRange0)
                .removeMagneticFluxDensity3DValidRange(characteristicIndex0)
                .addMagneticFluxDensity3D(characteristicIndex1, BluetoothGattCharacteristic.PROPERTY_READ, BluetoothGatt.GATT_SUCCESS, 0, originalValue1.getBytes())
                .setMagneticFluxDensity3DEsMeasurement(characteristicIndex1, new EnvironmentalSensingMeasurement(new byte[2], 1, 0, 0, 0, 0))
                .setMagneticFluxDensity3DValidRange(characteristicIndex1, validRange1)
                .removeMagneticFluxDensity3DValidRange(characteristicIndex1)
                .addDescriptorValueChanged(new ClientCharacteristicConfiguration(BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE))
                .build();
        callback.setup(MOCK_BLE_SERVER_CONNECTION);
        assertFalse(bluetoothGattServiceList.isEmpty());
