...
public class EnvironmentalSensingServiceMockCallbackBuilderTest_GustFactor extends AbstractPeripherallTest {
    ...
    public void test_addGustFactor_00002() {
        ...
        assertEquals(GUST_FACTOR_CHARACTERISTIC, bluetoothGattCharacteristic.getUuid());
