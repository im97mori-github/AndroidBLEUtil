...
public class SCControlPointCharacteristicData extends CharacteristicData {
    ...
    public SCControlPointCharacteristicData(@NonNull List<DescriptorData> descriptorDataList
        ...
        this.startSensorCalibrationResponseValue = startSensorCalibrationResponseValue;
    ...
    public SCControlPointCharacteristicData(@NonNull Parcel in) {
        ...
        startSensorCalibrationResponseValue = in.readInt();
        ...
        if (highPriorityResponseData == null) {
            ...
            try {
                if (currentData != null) {
                    ...
                    } else if (scControlPoint.isOpCodeStartSensorCalibration(scControlPoint.getOpCode())) {
                        result = new SCControlPoint(SCControlPoint.OP_CODE_RESPONSE_CODE, 0, 0, SCControlPoint.OP_CODE_START_SENSOR_CALIBRATION, startSensorCalibrationResponseValue, new byte[0]).getBytes();
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        ...
        dest.writeInt(startSensorCalibrationResponseValue);
