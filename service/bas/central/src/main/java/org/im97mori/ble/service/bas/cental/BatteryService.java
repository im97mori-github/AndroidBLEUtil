...
public class BatteryService extends AbstractCentralService {
    ...
    public synchronized void onDescriptorReadFailed(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @NonNull UUID descriptorUUID, int status, @Nullable Bundle argument) {
        if (mBLEConnection.getBluetoothDevice().equals(bluetoothDevice) && BATTERY_SERVICE.equals(serviceUUID) && BATTERY_LEVEL_CHARACTERISTIC.equals(characteristicUUID)) {
            if (CLIENT_CHARACTERISTIC_CONFIGURATION_DESCRIPTOR.equals(descriptorUUID)) {
                mBatteryServiceCallback.onClientCharacteristicConfigurationReadFailed(taskId, bluetoothDevice, serviceUUID, serviceInstanceId, characteristicUUID, characteristicInstanceId, getIndex(serviceInstanceId, characteristicInstanceId), status, argument);
            } else if (CHARACTERISTIC_PRESENTATION_FORMAT_DESCRIPTOR.equals(descriptorUUID)) {
                mBatteryServiceCallback.onCharacteristicPresentationFormatReadFailed(taskId, bluetoothDevice, serviceUUID, serviceInstanceId, characteristicUUID, characteristicInstanceId, getIndex(serviceInstanceId, characteristicInstanceId), status, argument);
            }
        }
    ...
    public synchronized void onDescriptorReadTimeout(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @NonNull UUID descriptorUUID, long timeout, @Nullable Bundle argument) {
        if (mBLEConnection.getBluetoothDevice().equals(bluetoothDevice) && BATTERY_SERVICE.equals(serviceUUID) && BATTERY_LEVEL_CHARACTERISTIC.equals(characteristicUUID)) {
            if (CLIENT_CHARACTERISTIC_CONFIGURATION_DESCRIPTOR.equals(descriptorUUID)) {
                mBatteryServiceCallback.onClientCharacteristicConfigurationReadTimeout(taskId, bluetoothDevice, serviceUUID, serviceInstanceId, characteristicUUID, characteristicInstanceId, getIndex(serviceInstanceId, characteristicInstanceId), timeout, argument);
            } else if (CHARACTERISTIC_PRESENTATION_FORMAT_DESCRIPTOR.equals(descriptorUUID)) {
                mBatteryServiceCallback.onCharacteristicPresentationFormatReadTimeout(taskId, bluetoothDevice, serviceUUID, serviceInstanceId, characteristicUUID, characteristicInstanceId, getIndex(serviceInstanceId, characteristicInstanceId), timeout, argument);
            }
        }
    ...
    /**
     * @see #isNotificatable(int)
     */
    public synchronized boolean isNotificatable() {
        return isNotificatable(0);
    }
    ...
    /**
     * @see #getCharacteristicPresentationFormat(int)
     */
    @Nullable
    public synchronized Integer getCharacteristicPresentationFormat() {
        return getCharacteristicPresentationFormat(0);
    }
     ...
     * @param index Battery Service index
     * @return task id. if {@code null} returned, service is not ready or index is out of range
     * @see BatteryServiceCallback#onCharacteristicPresentationFormatReadSuccess(Integer, BluetoothDevice, UUID, Integer, UUID, Integer, Integer, CharacteristicPresentationFormatAndroid, Bundle)
     * @see BatteryServiceCallback#onCharacteristicPresentationFormatReadFailed(Integer, BluetoothDevice, UUID, Integer, UUID, Integer, Integer, int, Bundle)
     * @see BatteryServiceCallback#onCharacteristicPresentationFormatReadTimeout(Integer, BluetoothDevice, UUID, Integer, UUID, Integer, Integer, long, Bundle)
     */
    @Nullable
    ...
    /**
     * @see #getClientCharacteristicConfiguration(int)
     */
    @Nullable
    public synchronized Integer getClientCharacteristicConfiguration() {
        return getClientCharacteristicConfiguration(0);
    }
     ...
     * @param index Battery Service index
     * @return task id. if {@code null} returned, service is not ready or index is out of range
     * @see BatteryServiceCallback#onClientCharacteristicConfigurationReadSuccess(Integer, BluetoothDevice, UUID, Integer, UUID, Integer, Integer, ClientCharacteristicConfigurationAndroid, Bundle)
     * @see BatteryServiceCallback#onClientCharacteristicConfigurationReadFailed(Integer, BluetoothDevice, UUID, Integer, UUID, Integer, Integer, int, Bundle)
     * @see BatteryServiceCallback#onClientCharacteristicConfigurationReadTimeout(Integer, BluetoothDevice, UUID, Integer, UUID, Integer, Integer, long, Bundle)
     */
    @Nullable
    ...
    /**
     * @see #startNotification(int)
     */
    @Nullable
    public synchronized Integer startNotification() {
        return startNotification(0);
    }
    ...
    /**
     * @see #stopNotification(int)
     */
    @Nullable
    public synchronized Integer stopNotification() {
        return stopNotification(0);
    }
