...
/**
 * Alert Notification Service (Service UUID: 0x1811) callback
 */
public interface AlertNotificationServiceCallback {

    /**
     * Read Supported New Alert Category success callback
     *
     ...
     */
    void onSupportedNewAlertCategoryReadSuccess(@NonNull Integer taskId
            , @NonNull BluetoothDevice bluetoothDevice
            , @NonNull UUID serviceUUID
            , @NonNull Integer serviceInstanceId
            , @NonNull UUID characteristicUUID
            , @NonNull Integer characteristicInstanceId
            , @NonNull SupportedNewAlertCategoryAndroid supportedNewAlertCategoryAndroid
            , @Nullable Bundle argument);

    /**
     * Read Supported New Alert Category error callback
     *
     * @param taskId                   task id
     * @param bluetoothDevice          BLE device
     * @param serviceUUID              service {@link UUID}
     ...
     * @param argument                 callback argument
     */
    void onSupportedNewAlertCategoryReadFailed(@NonNull Integer taskId
            , @NonNull BluetoothDevice bluetoothDevice
            , @NonNull UUID serviceUUID
    ...
    /**
     * Read Supported New Alert Category timeout callback
     *
     * @param taskId                   task id
     * @param bluetoothDevice          BLE device
     * @param serviceUUID              service {@link UUID}
     ...
     * @param argument                 callback argument
     */
    void onSupportedNewAlertCategoryReadTimeout(@NonNull Integer taskId
            , @NonNull BluetoothDevice bluetoothDevice
            , @NonNull UUID serviceUUID
            , @Nullable Integer serviceInstanceId
            , @NonNull UUID characteristicUUID
    ...
    /**
     * Read New Alert's Client Characteristic Configuration success callback
     *
     * @param taskId                                   task id
     * @param bluetoothDevice                          BLE device
     * @param serviceUUID                              service {@link UUID}
     ...
     * @param argument                                 callback argument
     */
    void onNewAlertClientCharacteristicConfigurationReadSuccess(@NonNull Integer taskId
            , @NonNull BluetoothDevice bluetoothDevice
            , @NonNull UUID serviceUUID
            , @NonNull Integer serviceInstanceId
            , @NonNull UUID characteristicUUID
    ...
    /**
     * Read New Alert's Client Characteristic Configuration error callback
     *
     * @param taskId                   task id
     * @param bluetoothDevice          BLE device
     * @param serviceUUID              service {@link UUID}
     ...
     * @param argument                 callback argument
     */
    void onNewAlertClientCharacteristicConfigurationReadFailed(@NonNull Integer taskId
            , @NonNull BluetoothDevice bluetoothDevice
            , @NonNull UUID serviceUUID
            , @Nullable Integer serviceInstanceId
            , @NonNull UUID characteristicUUID
    ...
    /**
     * Read New Alert's Client Characteristic Configuration timeout callback
     *
     * @param taskId                   task id
     * @param bluetoothDevice          BLE device
     * @param serviceUUID              service {@link UUID}
     ...
     * @param argument                 callback argument
     */
    void onNewAlertClientCharacteristicConfigurationReadTimeout(@NonNull Integer taskId
            , @NonNull BluetoothDevice bluetoothDevice
            , @NonNull UUID serviceUUID
            , @Nullable Integer serviceInstanceId
            , @NonNull UUID characteristicUUID
    ...
    void onNewAlertNotified(@NonNull BluetoothDevice bluetoothDevice
            ...
            , @NonNull UUID characteristicUUID
            , @NonNull Integer characteristicInstanceId
            , @NonNull NewAlertAndroid newAlertAndroid);

    /**
     * Read Supported Unread Alert Category success callback
     *
     * @param taskId                              task id
     * @param bluetoothDevice                     BLE device
     * @param serviceUUID                         service {@link UUID}
     ...
     * @param argument                            callback argument
     */
    void onSupportedUnreadAlertCategoryReadSuccess(@NonNull Integer taskId
            , @NonNull BluetoothDevice bluetoothDevice
            , @NonNull UUID serviceUUID
            , @NonNull Integer serviceInstanceId
            , @NonNull UUID characteristicUUID
            , @NonNull Integer characteristicInstanceId
            , @NonNull SupportedUnreadAlertCategoryAndroid supportedUnreadAlertCategoryAndroid
            , @Nullable Bundle argument);

    /**
     * Read Supported Unread Alert Category error callback
     *
     * @param taskId                   task id
     * @param bluetoothDevice          BLE device
     * @param serviceUUID              service {@link UUID}
     ...
     * @param argument                 callback argument
     */
    void onSupportedUnreadAlertCategoryReadFailed(@NonNull Integer taskId
            , @NonNull BluetoothDevice bluetoothDevice
            , @NonNull UUID serviceUUID
            , @Nullable Integer serviceInstanceId
            , @NonNull UUID characteristicUUID
    ...
    /**
     * Read Supported Unread Alert Category timeout callback
     *
     * @param taskId                   task id
     * @param bluetoothDevice          BLE device
     * @param serviceUUID              service {@link UUID}
     ...
     * @param argument                 callback argument
     */
    void onSupportedUnreadAlertCategoryReadTimeout(@NonNull Integer taskId
            , @NonNull BluetoothDevice bluetoothDevice
            , @NonNull UUID serviceUUID
            , @Nullable Integer serviceInstanceId
            , @NonNull UUID characteristicUUID
    ...
    /**
     * Read Unread Alert Status's Client Characteristic Configuration success callback
     *
     * @param taskId                                   task id
     * @param bluetoothDevice                          BLE device
     * @param serviceUUID                              service {@link UUID}
     ...
     * @param argument                                 callback argument
     */
    void onUnreadAlertStatusClientCharacteristicConfigurationReadSuccess(@NonNull Integer taskId
            , @NonNull BluetoothDevice bluetoothDevice
            , @NonNull UUID serviceUUID
            , @NonNull Integer serviceInstanceId
            , @NonNull UUID characteristicUUID
    ...
    /**
     * Read Unread Alert Status's Client Characteristic Configuration error callback
     *
     * @param taskId                   task id
     * @param bluetoothDevice          BLE device
     * @param serviceUUID              service {@link UUID}
     ...
     * @param argument                 callback argument
     */
    void onUnreadAlertStatusClientCharacteristicConfigurationReadFailed(@NonNull Integer taskId
            , @NonNull BluetoothDevice bluetoothDevice
            , @NonNull UUID serviceUUID
            , @Nullable Integer serviceInstanceId
            , @NonNull UUID characteristicUUID
    ...
    /**
     * Read Unread Alert Status's Client Characteristic Configuration timeout callback
     *
     * @param taskId                   task id
     * @param bluetoothDevice          BLE device
     * @param serviceUUID              service {@link UUID}
     ...
     * @param argument                 callback argument
     */
    void onUnreadAlertStatusClientCharacteristicConfigurationReadTimeout(@NonNull Integer taskId
            , @NonNull BluetoothDevice bluetoothDevice
            , @NonNull UUID serviceUUID
            , @Nullable Integer serviceInstanceId
            , @NonNull UUID characteristicUUID
    ...
    /**
     * Unread Alert Status notified callback
     *
     * @param bluetoothDevice          BLE device
     * @param serviceUUID              service {@link UUID}
     * @param serviceInstanceId        task target service incetanceId {@link BluetoothGattService#getInstanceId()}
    ...
    void onUnreadAlertStatusNotified(@NonNull BluetoothDevice bluetoothDevice
            ...
            , @NonNull UUID characteristicUUID
            , @NonNull Integer characteristicInstanceId
            , @NonNull UnreadAlertStatusAndroid unreadAlertStatusAndroid);

    /**
     * Write Alert Notification Control Point success callback
     *
     * @param taskId                               task id
     * @param bluetoothDevice                      BLE device
     * @param serviceUUID                          service {@link UUID}
     ...
     * @param argument                             callback argument
     */
    void onAlertNotificationControlPointWriteSuccess(@NonNull Integer taskId
            , @NonNull BluetoothDevice bluetoothDevice
            , @NonNull UUID serviceUUID
            , @NonNull Integer serviceInstanceId
            , @NonNull UUID characteristicUUID
            , @NonNull Integer characteristicInstanceId
            , @NonNull AlertNotificationControlPointAndroid alertNotificationControlPointAndroid
            , @Nullable Bundle argument);

    /**
     * Write Alert Notification Control Point error callback
     *
     * @param taskId                   task id
     * @param bluetoothDevice          BLE device
     * @param serviceUUID              service {@link UUID}
     ...
     * @param argument                 callback argument
     */
    void onAlertNotificationControlPointWriteFailed(@NonNull Integer taskId
            , @NonNull BluetoothDevice bluetoothDevice
            , @NonNull UUID serviceUUID
            , @Nullable Integer serviceInstanceId
            , @NonNull UUID characteristicUUID
    ...
    /**
     * Write Alert Notification Control Point timeout callback
     *
     * @param taskId                   task id
     * @param bluetoothDevice          BLE device
     * @param serviceUUID              service {@link UUID}
     ...
     * @param argument                 callback argument
     */
    void onAlertNotificationControlPointWriteTimeout(@NonNull Integer taskId
            , @NonNull BluetoothDevice bluetoothDevice
            , @NonNull UUID serviceUUID
            , @Nullable Integer serviceInstanceId
            , @NonNull UUID characteristicUUID
