...
public class HrpCallbackSample implements HeartRateProfileCallback {
    ...
    public static class Builder {
        ...
        public HrpCallbackSample build() {
            return new HrpCallbackSample(mSampleCallback);
        }
    }
    ...
    public HrpCallbackSample(SampleCallback sampleCallback) {
        mSampleCallback = sampleCallback;
    }
