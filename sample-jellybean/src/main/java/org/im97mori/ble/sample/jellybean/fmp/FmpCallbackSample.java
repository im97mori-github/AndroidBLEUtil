...
public class FmpCallbackSample implements FindMeProfileCallback {
    ...
    public static class Builder {
        ...
        public FmpCallbackSample build() {
            return new FmpCallbackSample(mSampleCallback);
        }
    }
    ...
    public FmpCallbackSample(SampleCallback sampleCallback) {
        mSampleCallback = sampleCallback;
    }
