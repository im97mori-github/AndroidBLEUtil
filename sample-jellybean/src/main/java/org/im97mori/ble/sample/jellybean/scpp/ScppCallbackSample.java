package org.im97mori.ble.sample.jellybean.scpp;
...
public class ScppCallbackSample implements ScanParametersProfileCallback {
    ...
    public ScppCallbackSample(SampleCallback sampleCallback) {
        mSampleCallback = sampleCallback;
    }
