...
public class AnpCallbackSample implements AlertNotificationProfileCallback {
    ...
    public static class Builder {
        ...
        public AnpCallbackSample build() {
            return new AnpCallbackSample(mSampleCallback);
        }
    }
    ...
    public AnpCallbackSample(SampleCallback sampleCallback) {
        mSampleCallback = sampleCallback;
    }
