...
import org.im97mori.ble.profile.tip.central.TimeProfileCallback;
import org.im97mori.ble.sample.lolipop.SampleCallback;
import org.im97mori.ble.sample.lolipop.cts.CtsCallbackSample;
import org.im97mori.ble.sample.lolipop.ndcs.NdcsCallbackSample;
import org.im97mori.ble.sample.lolipop.rtus.RtusCallbackSample;
...
public class TipCallbackSample extends TimeProfileMockCallback implements TimeProfileCallback, BLEServerCallback {
    ...
    public static class Builder extends TimeProfileMockCallback.Builder<TipCallbackSample> {

        private final SampleCallback mSampleCallback;

        public Builder(@NonNull Context context, SampleCallback sampleCallback, boolean hasNdcs, boolean hasRtus) {
            super(context, new CtsCallbackSample.Builder(sampleCallback), hasNdcs ? new NdcsCallbackSample.Builder(sampleCallback) : null, hasRtus ? new RtusCallbackSample.Builder(sampleCallback) : null);
            mSampleCallback = sampleCallback;
        }

        @Override
        public TipCallbackSample build() {
            return new TipCallbackSample(mContext
                    , mCurrentTimeServiceMockCallbackBuilder.build()
    ...
    public TipCallbackSample(Context context, SampleCallback sampleCallback) {
        this(context, null, null, null, sampleCallback);
    }

    public TipCallbackSample(Context context, CurrentTimeServiceMockCallback currentTimeServiceMockCallback, NextDstChangeServiceMockCallback nextDstChangeServiceMockCallback, ReferenceTimeUpdateServiceMockCallback referenceTimeUpdateServiceMockCallback, SampleCallback sampleCallback) {
        super(context, currentTimeServiceMockCallback, nextDstChangeServiceMockCallback, referenceTimeUpdateServiceMockCallback);
        mSampleCallback = sampleCallback;
    }
    ...
    public void onScanFinished(@NonNull Set<BluetoothDevice> bluetoothDeviceSet, long timeout, @Nullable Bundle argument) {
        if (!bluetoothDeviceSet.isEmpty() && mSampleCallback instanceof TipCentralSampleActivity) {
            ((TipCentralSampleActivity) mSampleCallback).mBluetoothDevice = bluetoothDeviceSet.iterator().next();
        }
    ...
    @Override
    public void onCurrentTimeNotificateStartSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @NonNull Integer descriptorInstanceId, @Nullable Bundle argument) {
        callback(bluetoothDevice, serviceInstanceId, characteristicUUID, characteristicInstanceId);
    }

    @Override
    public void onCurrentTimeNotificateStartFailed(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @Nullable Integer descriptorInstanceId, int status, @Nullable Bundle argument) {
        callback(bluetoothDevice, serviceInstanceId, characteristicUUID, characteristicInstanceId, status);
    }

    @Override
    public void onCurrentTimeNotificateStartTimeout(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @Nullable Integer descriptorInstanceId, long timeout, @Nullable Bundle argument) {
        callback(bluetoothDevice, serviceInstanceId, characteristicUUID, characteristicInstanceId, timeout);
    }

    @Override
    public void onCurrentTimeNotificateStopSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @NonNull Integer descriptorInstanceId, @Nullable Bundle argument) {
        callback(bluetoothDevice, serviceInstanceId, characteristicUUID, characteristicInstanceId);
    }

    @Override
    public void onCurrentTimeNotificateStopFailed(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @Nullable Integer descriptorInstanceId, int status, @Nullable Bundle argument) {
        callback(bluetoothDevice, serviceInstanceId, characteristicUUID, characteristicInstanceId, status);
    }

    @Override
    public void onCurrentTimeNotificateStopTimeout(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @Nullable Integer descriptorInstanceId, long timeout, @Nullable Bundle argument) {
        callback(bluetoothDevice, serviceInstanceId, characteristicUUID, characteristicInstanceId, timeout);
    }
    ...
    public void onLocalTimeInformationReadSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @NonNull Integer serviceInstanceId, @NonNull UUID characteristicUUID, @NonNull Integer characteristicInstanceId, @NonNull LocalTimeInformationAndroid localTimeInformationAndroid, @Nullable Bundle argument) {
        callback(bluetoothDevice, serviceInstanceId, characteristicUUID, characteristicInstanceId, localTimeInformationAndroid.getTimeZone(), localTimeInformationAndroid.getDstOffset());
    }
    ...
    public void onReferenceTimeInformationReadSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @NonNull Integer serviceInstanceId, @NonNull UUID characteristicUUID, @NonNull Integer characteristicInstanceId, @NonNull ReferenceTimeInformationAndroid referenceTimeInformationAndroid, @Nullable Bundle argument) {
        callback(bluetoothDevice, serviceInstanceId, characteristicUUID, characteristicInstanceId, referenceTimeInformationAndroid.getTimeSource(), referenceTimeInformationAndroid.getDaysSinceUpdate(), referenceTimeInformationAndroid.getHoursSinceUpdate());
    }
    ...
    public void onTimeWithDstReadSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @NonNull Integer serviceInstanceId, @NonNull UUID characteristicUUID, @NonNull Integer characteristicInstanceId, @NonNull TimeWithDstAndroid timeWithDstAndroid, @Nullable Bundle argument) {
        callback(bluetoothDevice, serviceInstanceId, characteristicUUID, characteristicInstanceId, timeWithDstAndroid.getYear(), timeWithDstAndroid.getMonth(), timeWithDstAndroid.getDay(), timeWithDstAndroid.getHours(), timeWithDstAndroid.getMinutes(), timeWithDstAndroid.getSeconds(), timeWithDstAndroid.getDstOffset());
    }
