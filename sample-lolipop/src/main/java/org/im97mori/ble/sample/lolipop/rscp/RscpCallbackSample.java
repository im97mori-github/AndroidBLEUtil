...
import org.im97mori.ble.profile.rscp.central.RunningSpeedAndCadenceProfileCallback;
...
import org.im97mori.ble.sample.lolipop.rscs.RscsCallbackSample;
...
public class RscpCallbackSample extends RunningSpeedAndCadenceProfileMockCallback implements RunningSpeedAndCadenceProfileCallback, BLEServerCallback {

    public static class Builder extends RunningSpeedAndCadenceProfileMockCallback.Builder<RscpCallbackSample> {

        private final SampleCallback mSampleCallback;

        public Builder(@NonNull Context context, SampleCallback sampleCallback, boolean hasDis) {
            super(context, new RscsCallbackSample.Builder(sampleCallback), hasDis ? new DisCallbackSample.Builder(sampleCallback) : null);
            mSampleCallback = sampleCallback;
        }

        @Override
        public RscpCallbackSample build() {
            return new RscpCallbackSample(mContext, mRunningSpeedAndCadenceServiceMockCallback.build()
    ...
    public RscpCallbackSample(Context context, SampleCallback sampleCallback) {
        this(context, null, null, sampleCallback);
    }

    public RscpCallbackSample(Context context, RunningSpeedAndCadenceServiceMockCallback runningSpeedAndCadenceServiceMockCallback, DeviceInformationServiceMockCallback deviceInformationServiceMockCallback, SampleCallback sampleCallback) {
        super(context, runningSpeedAndCadenceServiceMockCallback, deviceInformationServiceMockCallback);
        mSampleCallback = sampleCallback;
    }
    ...
    public void onScanFinished(@NonNull Set<BluetoothDevice> bluetoothDeviceSet, long timeout, @Nullable Bundle argument) {
        if (!bluetoothDeviceSet.isEmpty() && mSampleCallback instanceof RscpCentralSampleActivity) {
            ((RscpCentralSampleActivity) mSampleCallback).mBluetoothDevice = bluetoothDeviceSet.iterator().next();
        }
    ...
    @Override
    public void onRSCMeasurementNotifyStartSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @NonNull Integer descriptorInstanceId, @Nullable Bundle argument) {
        callback(bluetoothDevice, serviceInstanceId, characteristicUUID, characteristicInstanceId);
    }

    @Override
    public void onRSCMeasurementNotifyStartFailed(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @Nullable Integer descriptorInstanceId, int status, @Nullable Bundle argument) {
        callback(bluetoothDevice, serviceInstanceId, characteristicUUID, characteristicInstanceId, status);
    }

    @Override
    public void onRSCMeasurementNotifyStartTimeout(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @Nullable Integer descriptorInstanceId, long timeout, @Nullable Bundle argument) {
        callback(bluetoothDevice, serviceInstanceId, characteristicUUID, characteristicInstanceId, timeout);
    }

    @Override
    public void onRSCMeasurementNotifyStopSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @NonNull Integer descriptorInstanceId, @Nullable Bundle argument) {
        callback(bluetoothDevice, serviceInstanceId, characteristicUUID, characteristicInstanceId);
    }

    @Override
    public void onRSCMeasurementNotifyStopFailed(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @Nullable Integer descriptorInstanceId, int status, @Nullable Bundle argument) {
        callback(bluetoothDevice, serviceInstanceId, characteristicUUID, characteristicInstanceId, status);
    }

    @Override
    public void onRSCMeasurementNotifyStopTimeout(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @Nullable Integer descriptorInstanceId, long timeout, @Nullable Bundle argument) {
        callback(bluetoothDevice, serviceInstanceId, characteristicUUID, characteristicInstanceId, timeout);
    }
    ...
    public void onRSCMeasurementNotified(@NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @NonNull Integer serviceInstanceId, @NonNull UUID characteristicUUID, @NonNull Integer characteristicInstanceId, @NonNull RSCMeasurementAndroid rscMeasurementAndroid) {
        callback(bluetoothDevice
                ...
                , rscMeasurementAndroid.getFlags()
                , rscMeasurementAndroid.getInstantaneousSpeed()
                , rscMeasurementAndroid.getInstantaneousCadence()
                , rscMeasurementAndroid.getInstantaneousStrideLength()
                , rscMeasurementAndroid.getTotalDistance()
                , rscMeasurementAndroid.isFlagsWalkingOrRunningStatusBitsWalking());
    }
