...
import org.im97mori.ble.profile.cpp.central.CyclingPowerProfileCallback;
...
import org.im97mori.ble.sample.lolipop.cps.CpsCallbackSample;
...
public class CppCallbackSample extends CyclingPowerProfileMockCallback implements CyclingPowerProfileCallback, BLEServerCallback {

    public static class Builder extends CyclingPowerProfileMockCallback.Builder<CppCallbackSample> {

        private final SampleCallback mSampleCallback;

        public Builder(@NonNull Context context, SampleCallback sampleCallback, boolean hasDis, boolean hasBas) {
            super(context, new CpsCallbackSample.Builder(sampleCallback), hasDis ? new DisCallbackSample.Builder(sampleCallback) : null, hasBas ? new BasCallbackSample.Builder(sampleCallback) : null);
            mSampleCallback = sampleCallback;
        }

        @Override
        public CppCallbackSample build() {
            return new CppCallbackSample(mContext, mCyclingPowerServiceMockCallbackBuilder.build()
    ...
    public CppCallbackSample(Context context, SampleCallback sampleCallback) {
        this(context, null, null, null, sampleCallback);
    }

    public CppCallbackSample(Context context, CyclingPowerServiceMockCallback cyclingPowerServiceMockCallback, DeviceInformationServiceMockCallback deviceInformationServiceMockCallback, BatteryServiceMockCallback batteryServiceMockCallback, SampleCallback sampleCallback) {
        super(context, cyclingPowerServiceMockCallback, deviceInformationServiceMockCallback, batteryServiceMockCallback);
        mSampleCallback = sampleCallback;
    }
    ...
    public void onScanFinished(@NonNull Set<BluetoothDevice> bluetoothDeviceSet, long timeout, @Nullable Bundle argument) {
        if (!bluetoothDeviceSet.isEmpty() && mSampleCallback instanceof CppCentralSampleActivity) {
            ((CppCentralSampleActivity) mSampleCallback).mBluetoothDevice = bluetoothDeviceSet.iterator().next();
        }
    ...
    public void onCyclingPowerFeatureReadSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @NonNull Integer serviceInstanceId, @NonNull UUID characteristicUUID, @NonNull Integer characteristicInstanceId, @NonNull CyclingPowerFeatureAndroid cyclingPowerFeatureAndroid, @Nullable Bundle argument) {
        callback(Arrays.toString(cyclingPowerFeatureAndroid.getCyclingPowerFeature()));
    }
    ...
    @Override
    public void onCyclingPowerMeasurementNotifyStartSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @NonNull Integer descriptorInstanceId, @Nullable Bundle argument) {
        callback();
    }

    @Override
    public void onCyclingPowerMeasurementNotifyStartFailed(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @Nullable Integer descriptorInstanceId, int status, @Nullable Bundle argument) {
        callback(status);
    }

    @Override
    public void onCyclingPowerMeasurementNotifyStartTimeout(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @Nullable Integer descriptorInstanceId, long timeout, @Nullable Bundle argument) {
        callback(timeout);
    }

    @Override
    public void onCyclingPowerMeasurementNotifyStopSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @NonNull Integer descriptorInstanceId, @Nullable Bundle argument) {
        callback();
    }

    @Override
    public void onCyclingPowerMeasurementNotifyStopFailed(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @Nullable Integer descriptorInstanceId, int status, @Nullable Bundle argument) {
        callback(status);
    }

    @Override
    public void onCyclingPowerMeasurementNotifyStopTimeout(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @Nullable Integer descriptorInstanceId, long timeout, @Nullable Bundle argument) {
        callback(timeout);
    }
    ...
    public void onCyclingPowerMeasurementNotified(@NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @NonNull Integer serviceInstanceId, @NonNull UUID characteristicUUID, @NonNull Integer characteristicInstanceId, @NonNull CyclingPowerMeasurementAndroid cyclingPowerMeasurementAndroid) {
        callback(Arrays.toString(cyclingPowerMeasurementAndroid.getFlags())
                , cyclingPowerMeasurementAndroid.getInstantaneousPower()
                , cyclingPowerMeasurementAndroid.getPedalPowerBalance()
                , cyclingPowerMeasurementAndroid.getAccumulatedTorque()
                , cyclingPowerMeasurementAndroid.getWheelRevolutionDataCumulativeWheelRevolutions()
                , cyclingPowerMeasurementAndroid.getWheelRevolutionDataLastWheelEventTime()
                , cyclingPowerMeasurementAndroid.getCrankRevolutionDataCumulativeCrankRevolutions()
                , cyclingPowerMeasurementAndroid.getCrankRevolutionDataLastCrankEventTime()
                , cyclingPowerMeasurementAndroid.getExtremeForceMagnitudesMaximumForceMagnitude()
                , cyclingPowerMeasurementAndroid.getExtremeForceMagnitudesMinimumForceMagnitude()
                , cyclingPowerMeasurementAndroid.getExtremeTorqueMagnitudesMaximumTorqueMagnitude()
                , cyclingPowerMeasurementAndroid.getExtremeTorqueMagnitudesMinimumTorqueMagnitude()
                , cyclingPowerMeasurementAndroid.getExtremeAnglesMaximumAngle()
                , cyclingPowerMeasurementAndroid.getExtremeAnglesMinimumAngle()
                , cyclingPowerMeasurementAndroid.getTopDeadSpotAngle()
                , cyclingPowerMeasurementAndroid.getBottomDeadSpotAngle()
                , cyclingPowerMeasurementAndroid.getAccumulatedEnergy());
    }
    ...
    public void onSensorLocationReadSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @NonNull Integer serviceInstanceId, @NonNull UUID characteristicUUID, @NonNull Integer characteristicInstanceId, @NonNull SensorLocationAndroid sensorLocationAndroid, @Nullable Bundle argument) {
        callback(sensorLocationAndroid.getSensorLocation());
    }
    ...
    public void onCyclingPowerControlPointWriteSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @NonNull Integer serviceInstanceId, @NonNull UUID characteristicUUID, @NonNull Integer characteristicInstanceId, @NonNull CyclingPowerControlPointAndroid cyclingPowerControlPointAndroid, @Nullable Bundle argument) {
        callback(cyclingPowerControlPointAndroid.getOpCodes()
                , Arrays.toString(cyclingPowerControlPointAndroid.getParameterValue())
                , cyclingPowerControlPointAndroid.getRequestOpCode()
                , cyclingPowerControlPointAndroid.getResponseValue()
                , Arrays.toString(cyclingPowerControlPointAndroid.getResponseParameter())
                , cyclingPowerControlPointAndroid.hasManufacturerSpecificData()
                , cyclingPowerControlPointAndroid.getCompanyId()
                , cyclingPowerControlPointAndroid.getManfacturerSpecificDataLength()
                , Arrays.toString(cyclingPowerControlPointAndroid.getManfacturerSpecificData()));
    }
    ...
    public void onCyclingPowerControlPointIndicated(@NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @NonNull Integer serviceInstanceId, @NonNull UUID characteristicUUID, @NonNull Integer characteristicInstanceId, @NonNull CyclingPowerControlPointAndroid cyclingPowerControlPointAndroid) {
        callback(cyclingPowerControlPointAndroid.getOpCodes()
                ...
                , cyclingPowerControlPointAndroid.getCompanyId()
                , cyclingPowerControlPointAndroid.getManfacturerSpecificDataLength()
                , cyclingPowerControlPointAndroid.getManfacturerSpecificDataLength() == -1 ? null : Arrays.toString(cyclingPowerControlPointAndroid.getManfacturerSpecificData()));
    }
    ...
    @Override
    public void onCyclingPowerVectorNotifyStartSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @NonNull Integer descriptorInstanceId, @Nullable Bundle argument) {
        callback();
    }

    @Override
    public void onCyclingPowerVectorNotifyStartFailed(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @Nullable Integer descriptorInstanceId, int status, @Nullable Bundle argument) {
        callback(status);
    }

    @Override
    public void onCyclingPowerVectorNotifyStartTimeout(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @Nullable Integer descriptorInstanceId, long timeout, @Nullable Bundle argument) {
        callback(timeout);
    }

    @Override
    public void onCyclingPowerVectorNotifyStopSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @NonNull Integer descriptorInstanceId, @Nullable Bundle argument) {
        callback();
    }

    @Override
    public void onCyclingPowerVectorNotifyStopFailed(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @Nullable Integer descriptorInstanceId, int status, @Nullable Bundle argument) {
        callback(status);
    }

    @Override
    public void onCyclingPowerVectorNotifyStopTimeout(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceId, @Nullable Integer descriptorInstanceId, long timeout, @Nullable Bundle argument) {
        callback(timeout);
    }
    ...
    public void onCyclingPowerVectorNotified(@NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @NonNull Integer serviceInstanceId, @NonNull UUID characteristicUUID, @NonNull Integer characteristicInstanceId, @NonNull CyclingPowerVectorAndroid cyclingPowerVectorAndroid) {
        callback(cyclingPowerVectorAndroid.getFlags()
                , cyclingPowerVectorAndroid.getCrankRevolutionDataCumulativeCrankRevolutions()
                , cyclingPowerVectorAndroid.getCrankRevolutionDataLastCrankEventTime()
                , cyclingPowerVectorAndroid.getFirstCrankMeasurementAngle()
                , Arrays.toString(cyclingPowerVectorAndroid.getInstantaneousForceMagnitudeArray())
                , Arrays.toString(cyclingPowerVectorAndroid.getInstantaneousTorqueMagnitudeArray()));
    }
