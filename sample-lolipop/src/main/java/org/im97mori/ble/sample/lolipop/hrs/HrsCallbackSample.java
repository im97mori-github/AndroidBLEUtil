package org.im97mori.ble.sample.lolipop.hrs;
...
public class HrsCallbackSample extends HeartRateServiceMockCallback implements HeartRateServiceCallback, BLECallback {

    public static class Builder extends HeartRateServiceMockCallback.Builder<HrsCallbackSample> {
        ...
        @NonNull
        @Override
        public HrsCallbackSample build() {
            return new HrsCallbackSample(createData(), mSampleCallback);
        }
    }
    ...
    HrsCallbackSample(@NonNull ServiceData serviceData, SampleCallback sampleCallback) {
