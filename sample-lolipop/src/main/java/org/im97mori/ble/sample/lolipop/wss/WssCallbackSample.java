...
public class WssCallbackSample extends WspWeightScaleServiceMockCallback implements WeightScaleServiceCallback, BLECallback {

    public static class Builder extends WspWeightScaleServiceMockCallback.Builder<WssCallbackSample> {
        ...
        public WssCallbackSample build() {
            return new WssCallbackSample(createMockData(), mSampleCallback, mWspUserDataServiceMockCallback);
        }
    }
    ...
    WssCallbackSample(@NonNull MockData mockData, SampleCallback sampleCallback, @Nullable WspUserDataServiceMockCallback wspUserDataServiceMockCallback) {
