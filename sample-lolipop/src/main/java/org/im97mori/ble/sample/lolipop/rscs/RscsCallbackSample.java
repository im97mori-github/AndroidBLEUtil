package org.im97mori.ble.sample.lolipop.rscs;
...
public class RscsCallbackSample extends RunningSpeedAndCadenceServiceMockCallback implements RunningSpeedAndCadenceServiceCallback, BLECallback {

    public static class Builder extends RunningSpeedAndCadenceServiceMockCallback.Builder<RscsCallbackSample> {
        ...
        @NonNull
        @Override
        public RscsCallbackSample build() {
            return new RscsCallbackSample(createData(), mSampleCallback);
        }
    }
    ...
    RscsCallbackSample(@NonNull ServiceData serviceData, SampleCallback sampleCallback) {
