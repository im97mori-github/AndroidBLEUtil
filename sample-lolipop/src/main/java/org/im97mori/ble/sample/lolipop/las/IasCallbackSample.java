package org.im97mori.ble.sample.lolipop.las;
...
public class IasCallbackSample extends ImmediateAlertServiceMockCallback implements ImmediateAlertServiceCallback, BLECallback {
    ...
    public static class Builder extends ImmediateAlertServiceMockCallback.Builder<IasCallbackSample> {
        ...
        public IasCallbackSample build() {
            return new IasCallbackSample(createData(), mSampleCallback);
        }
    }
    ...
    IasCallbackSample(@NonNull ServiceData serviceData, SampleCallback sampleCallback) {
    ...
    private void callback(Object... logs) {
        ...
        for (int i = 0; i < stackTraceElementArray.length; i++) {
            ...
            if (IasCallbackSample.class.getName().equals(stackTraceElement.getClassName())
    ...
    public void onAlertLevelWriteSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @NonNull Integer serviceInstanceId, @NonNull UUID characteristicUUID, @NonNull Integer characteristicInstanceId, @NonNull AlertLevelAndroid alertLevelAndroid, @Nullable Bundle argument) {
        callback(bluetoothDevice, serviceUUID, serviceInstanceId, characteristicUUID, characteristicInstanceId, alertLevelAndroid.getAlertLevel());
    }
