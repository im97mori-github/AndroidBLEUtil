...
import org.im97mori.ble.profile.pxp.central.ProximityProfileCallback;
import org.im97mori.ble.profile.pxp.peripheral.ProximityProfileMockCallback;
import org.im97mori.ble.sample.lolipop.SampleCallback;
import org.im97mori.ble.sample.lolipop.las.IasCallbackSample;
import org.im97mori.ble.sample.lolipop.lls.LlsCallbackSample;
import org.im97mori.ble.sample.lolipop.tps.TpsCallbackSample;
...
public class PxpCallbackSample extends ProximityProfileMockCallback implements ProximityProfileCallback, BLEServerCallback {

    public static class Builder extends ProximityProfileMockCallback.Builder<PxpCallbackSample> {

        private final SampleCallback mSampleCallback;

        public Builder(@NonNull Context context, SampleCallback sampleCallback) {
            super(context, new LlsCallbackSample.Builder(sampleCallback), new IasCallbackSample.Builder(sampleCallback), new TpsCallbackSample.Builder(sampleCallback));
            mSampleCallback = sampleCallback;
        }

        @Override
        public PxpCallbackSample build() {
            return new PxpCallbackSample(mContext, mLinkLossServiceMockCallbackBuilder.build(), mImmediateAlertServiceMockCallbackBuilder.build(), mTxPowerServiceMockCallbackBuilder.build(), mSampleCallback);
        }
    }
    ...
    public PxpCallbackSample(Context context, SampleCallback sampleCallback) {
        this(context, null, null, null, sampleCallback);
    }

    public PxpCallbackSample(Context context
            , LinkLossServiceMockCallback linkLossServiceMockCallback
            , ImmediateAlertServiceMockCallback immediateAlertServiceMockCallback
            , TxPowerServiceMockCallback txPowerServiceMockCallback
            , SampleCallback sampleCallback) {
        super(context, linkLossServiceMockCallback, immediateAlertServiceMockCallback, txPowerServiceMockCallback);
        mSampleCallback = sampleCallback;
    }
    ...
    public void onScanFinished(@NonNull Set<BluetoothDevice> bluetoothDeviceSet, long timeout, @Nullable Bundle argument) {
        if (!bluetoothDeviceSet.isEmpty() && mSampleCallback instanceof PxpCentralSampleActivity) {
            ((PxpCentralSampleActivity) mSampleCallback).mBluetoothDevice = bluetoothDeviceSet.iterator().next();
        }
    ...
    public void onAlertLevelReadSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @NonNull Integer serviceInstanceId, @NonNull UUID characteristicUUID, @NonNull Integer characteristicInstanceId, @NonNull AlertLevelAndroid alertLevelAndroid, @Nullable Bundle argument) {
        callback(alertLevelAndroid.getAlertLevel());
    }
    ...
    public void onTxPowerLevelReadSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @NonNull Integer serviceInstanceId, @NonNull UUID characteristicUUID, @NonNull Integer characteristicInstanceId, @NonNull TxPowerLevelAndroid txPowerLevelAndroid, @Nullable Bundle argument) {
        callback(txPowerLevelAndroid.getTxPower());
    }
