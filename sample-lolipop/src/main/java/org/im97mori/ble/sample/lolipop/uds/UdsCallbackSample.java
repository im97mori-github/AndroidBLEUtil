...
public class UdsCallbackSample extends WspUserDataServiceMockCallback implements UserDataServiceCallback, BLECallback {

    public static class Builder extends WspUserDataServiceMockCallback.Builder<UdsCallbackSample> {
