package org.im97mori.ble.sample.lolipop.bms;
...
public class BmsCallbackSample extends BondManagementServiceMockCallback implements BondManagementServiceCallback, BLECallback {

    public static class Builder extends BondManagementServiceMockCallback.Builder<BmsCallbackSample> {
    ...
    public void onBondManagementControlPointWriteSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @NonNull Integer serviceInstanceId, @NonNull UUID characteristicUUID, @NonNull Integer characteristicInstanceId, @NonNull BondManagementControlPointAndroid bondManagementControlPointAndroid, @Nullable Bundle argument) {
        callback(serviceUUID, serviceInstanceId, characteristicUUID, characteristicInstanceId, Arrays.toString(bondManagementControlPointAndroid.getBytes()));
    }
