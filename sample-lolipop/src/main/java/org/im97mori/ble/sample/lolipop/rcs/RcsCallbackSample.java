package org.im97mori.ble.sample.lolipop.rcs;
...
public class RcsCallbackSample extends ReconnectionConfigurationServiceMockCallback implements ReconnectionConfigurationServiceCallback, BLECallback {

    public static class Builder extends ReconnectionConfigurationServiceMockCallback.Builder<RcsCallbackSample> {
    ...
    public void onRCSettingsReadSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @NonNull Integer serviceInstanceId, @NonNull UUID characteristicUUID, @NonNull Integer characteristicInstanceId, @NonNull RCSettingsAndroid rcSettingsAndroid, @Nullable Bundle argument) {
        callback(serviceUUID, serviceInstanceId, characteristicUUID, characteristicInstanceId, Arrays.toString(rcSettingsAndroid.getBytes()));
    }
