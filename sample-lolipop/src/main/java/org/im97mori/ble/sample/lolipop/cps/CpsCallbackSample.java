package org.im97mori.ble.sample.lolipop.cps;
...
public class CpsCallbackSample extends CyclingPowerServiceMockCallback implements CyclingPowerServiceCallback, BLECallback {

    public static class Builder extends CyclingPowerServiceMockCallback.Builder<CpsCallbackSample> {
        ...
        @NonNull
        @Override
        public CpsCallbackSample build() {
            return new CpsCallbackSample(createData(), mSampleCallback);
        }
    }
    ...
    CpsCallbackSample(@NonNull ServiceData serviceData, SampleCallback sampleCallback) {
    ...
    @Override
    public void onCyclingPowerMeasurementClientCharacteristicConfigurationReadTimeout(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceI, @Nullable Integer descriptorInstanceIdd, long timeout, @Nullable Bundle argument) {
        callback(timeout);
    }
    ...
    @Override
    public void onCyclingPowerMeasurementNotifyStopSuccess(@NonNull Integer taskId, @NonNull BluetoothDevice bluetoothDevice, @NonNull UUID serviceUUID, @Nullable Integer serviceInstanceId, @NonNull UUID characteristicUUID, @Nullable Integer characteristicInstanceI, @NonNull Integer descriptorInstanceIdd, @Nullable Bundle argument) {
        callback();
    }
