...
public class IncompleteListOf128BitServiceUUIDsAndroidTest extends TestBase {
    ...
    public void test_constructor_1_00101() {
        IncompleteListOf128BitServiceUUIDsAndroid result1 = new IncompleteListOf128BitServiceUUIDsAndroid();
        assertEquals(1, result1.getLength());
        assertEquals(INCOMPLETE_LIST_OF_128_BIT_SERVICE_CLASS_UUIDS_DATA_TYPE, result1.getDataType());
        assertEquals(0, result1.getUuidList().size());
    }
    ...
    public void test_constructor_1_00102() {
        ...
        IncompleteListOf128BitServiceUUIDsAndroid result1 = new IncompleteListOf128BitServiceUUIDsAndroid(uuid1);
        assertEquals(17, result1.getLength());
        assertEquals(INCOMPLETE_LIST_OF_128_BIT_SERVICE_CLASS_UUIDS_DATA_TYPE, result1.getDataType());
    ...
    public void test_constructor_1_00103() {
        ...
        IncompleteListOf128BitServiceUUIDsAndroid result1 = new IncompleteListOf128BitServiceUUIDsAndroid(uuid1, uuid2);
        assertEquals(33, result1.getLength());
        assertEquals(INCOMPLETE_LIST_OF_128_BIT_SERVICE_CLASS_UUIDS_DATA_TYPE, result1.getDataType());
        assertEquals(2, result1.getUuidList().size());
        assertEquals(uuid1, result1.getUuidList().get(0));
    ...
    public void test_constructor_1_00104() {
        ...
        IncompleteListOf128BitServiceUUIDsAndroid result1 = new IncompleteListOf128BitServiceUUIDsAndroid(Arrays.asList(uuid1, uuid2));
        assertEquals(33, result1.getLength());
        assertEquals(INCOMPLETE_LIST_OF_128_BIT_SERVICE_CLASS_UUIDS_DATA_TYPE, result1.getDataType());
        assertEquals(2, result1.getUuidList().size());
        assertEquals(uuid1, result1.getUuidList().get(0));
    ...
    public void test_constructor_2_00001() {
        ...
        IncompleteListOf128BitServiceUUIDsAndroid result1 = new IncompleteListOf128BitServiceUUIDsAndroid(data, 0);
        assertEquals(17, result1.getLength());
        assertEquals(INCOMPLETE_LIST_OF_128_BIT_SERVICE_CLASS_UUIDS_DATA_TYPE, result1.getDataType());
        assertEquals(UUID.fromString("00000000-0000-0000-0000-000000000000"), result1.getUuidList().get(0));
    }
