...
public class ListOf32BitServiceSolicitationUUIDsTest {
    ...
    public void constructTest1() {
        ...
        ListOf32BitServiceSolicitationUUIDs result = new ListOf32BitServiceSolicitationUUIDs(data, 0, data[0]);
        assertEquals(5, result.getLength());
        assertEquals(DATA_TYPE_LIST_OF_32_BIT_SERVICE_SOLICITATION_UUIDS, result.getDataType());
