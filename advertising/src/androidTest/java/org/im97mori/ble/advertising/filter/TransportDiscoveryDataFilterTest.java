...
public class TransportDiscoveryDataFilterTest {
    ...
    public void test_002() {
        ...
        expectData[0] = 4;
        expectData[1] = DATA_TYPE_TRANSPORT_DISCOVERY_DATA;
        ...
        AdvertisingDataParser parser = new AdvertisingDataParser.Builder(true).build();
        AdvertisingDataParser.AdvertisingDataParseResult result = parser.parse(actualData);
        AdvertisingDataFilter<AdvertisingDataParser.AdvertisingDataParseResult> filter = new TransportDiscoveryDataFilter(TransportDiscoveryData.CREATOR.createFromByteArray(expectData));
    ...
    public void test_003() {
        ...
        actualData[0] = 4;
        actualData[1] = DATA_TYPE_TRANSPORT_DISCOVERY_DATA;
