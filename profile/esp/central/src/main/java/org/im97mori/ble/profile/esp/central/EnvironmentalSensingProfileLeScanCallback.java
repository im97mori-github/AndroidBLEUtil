 ...
 */
public class EnvironmentalSensingProfileLeScanCallback extends FilteredLeScanCallback {
     ...
     */
    public EnvironmentalSensingProfileLeScanCallback(@NonNull FilteredLeScanCallbackInterface filteredLeScanCallbackInterface, @Nullable BluetoothAdapter.LeScanCallback leScanCallback) {
