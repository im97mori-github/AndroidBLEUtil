 ...
 */
public class HeartRateProfileLeScanCallback extends FilteredLeScanCallback {
     ...
     */
    public HeartRateProfileLeScanCallback(@NonNull FilteredLeScanCallbackInterface filteredLeScanCallbackInterface, @Nullable BluetoothAdapter.LeScanCallback leScanCallback) {
