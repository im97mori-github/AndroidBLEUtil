 ...
 */
public class HealthThermometerProfileScanCallback extends FilteredScanCallback {
     ...
     */
    public HealthThermometerProfileScanCallback(@NonNull FilteredScanCallbackInterface filteredScanCallbackInterface, @Nullable ScanCallback scanCallback) {
