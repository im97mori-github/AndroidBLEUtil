 ...
 */
public class FitnessMachineProfileLeScanCallback extends FilteredLeScanCallback {
     ...
     */
    public FitnessMachineProfileLeScanCallback(@NonNull FilteredLeScanCallbackInterface filteredLeScanCallbackInterface, @Nullable BluetoothAdapter.LeScanCallback leScanCallback) {
