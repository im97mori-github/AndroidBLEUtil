 ...
 */
public class CyclingPowerProfileLeScanCallback extends FilteredLeScanCallback {
     ...
     */
    public CyclingPowerProfileLeScanCallback(@NonNull FilteredLeScanCallbackInterface filteredLeScanCallbackInterface, @Nullable BluetoothAdapter.LeScanCallback leScanCallback) {
