 ...
 */
public class WeightScaleProfileLeScanCallback extends FilteredLeScanCallback {
     ...
     */
    public WeightScaleProfileLeScanCallback(@NonNull FilteredLeScanCallbackInterface filteredLeScanCallbackInterface, @Nullable BluetoothAdapter.LeScanCallback leScanCallback) {
