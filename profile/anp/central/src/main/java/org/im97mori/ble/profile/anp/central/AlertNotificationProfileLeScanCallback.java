 ...
 */
public class AlertNotificationProfileLeScanCallback extends FilteredLeScanCallback {
     ...
     */
    public AlertNotificationProfileLeScanCallback(@NonNull FilteredLeScanCallbackInterface filteredLeScanCallbackInterface, @Nullable BluetoothAdapter.LeScanCallback leScanCallback) {
