 ...
 */
public class TimeProfileLeScanCallback extends FilteredLeScanCallback {
     ...
     */
    public TimeProfileLeScanCallback(@NonNull UUID serviceUUID, @NonNull FilteredLeScanCallbackInterface filteredLeScanCallbackInterface, @Nullable BluetoothAdapter.LeScanCallback leScanCallback) {
