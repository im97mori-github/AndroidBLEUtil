...
public class CyclingSpeedAndCadenceProfileScanCallback extends FilteredScanCallback {
     ...
     */
    public CyclingSpeedAndCadenceProfileScanCallback(@NonNull FilteredScanCallbackInterface filteredScanCallbackInterface, @Nullable ScanCallback scanCallback) {
