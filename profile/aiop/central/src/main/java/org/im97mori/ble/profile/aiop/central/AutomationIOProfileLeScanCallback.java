 ...
 */
public class AutomationIOProfileLeScanCallback extends FilteredLeScanCallback {
     ...
     */
    public AutomationIOProfileLeScanCallback(@NonNull FilteredLeScanCallbackInterface filteredLeScanCallbackInterface, @Nullable BluetoothAdapter.LeScanCallback leScanCallback) {
