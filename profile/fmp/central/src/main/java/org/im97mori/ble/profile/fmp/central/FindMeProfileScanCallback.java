 ...
 */
public class FindMeProfileScanCallback extends FilteredScanCallback {
     ...
     */
    public FindMeProfileScanCallback(@NonNull FilteredScanCallbackInterface filteredScanCallbackInterface, @Nullable ScanCallback scanCallback) {
