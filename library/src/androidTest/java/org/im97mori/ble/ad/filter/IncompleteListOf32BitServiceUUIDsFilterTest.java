...
public class IncompleteListOf32BitServiceUUIDsFilterTest {
    ...
    public void test_002() {
        ...
        AdvertisingDataParser parser = new AdvertisingDataParser.Builder(true).build();
        AdvertisingDataParser.AdvertisingDataParseResult result = parser.parse(actualData);
        AdvertisingDataFilter<AdvertisingDataParser.AdvertisingDataParseResult> filter = new IncompleteListOf32BitServiceUUIDsFilter(IncompleteListOf32BitServiceUUIDs.CREATOR.createFromByteArray(expectData));
    ...
    public void test_101() {
        ...
        AdvertisingDataParser.AdvertisingDataParseResult result = parser.parse(actualData);
        AdvertisingDataFilter<AdvertisingDataParser.AdvertisingDataParseResult> filter = new IncompleteListOf32BitServiceUUIDsFilter(
                new IncompleteListOf32BitServiceUUIDs(expectData, 0, expectData.length / 2 - 1)
                , new IncompleteListOf32BitServiceUUIDs(expectData, expectData.length / 2, expectData.length / 2 - 1)
        );
        assertFalse(filter.isMatched(result));
    }
    ...
    public void test_102() {
        ...
        AdvertisingDataParser.AdvertisingDataParseResult result = parser.parse(actualData);
        AdvertisingDataFilter<AdvertisingDataParser.AdvertisingDataParseResult> filter = new IncompleteListOf32BitServiceUUIDsFilter(
                new IncompleteListOf32BitServiceUUIDs(expectData, 0, expectData.length - 1)
        );
        assertFalse(filter.isMatched(result));
    }
