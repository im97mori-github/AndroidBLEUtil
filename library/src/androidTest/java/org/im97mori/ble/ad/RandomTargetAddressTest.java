...
public class RandomTargetAddressTest {
    ...
    public void constructTest1() {
        ...
        RandomTargetAddress result = new RandomTargetAddress(data, 0, data[0]);
        assertEquals(7, result.getLength());
        assertEquals(DATA_TYPE_RANDOM_TARGET_ADDRESS, result.getDataType());
    ...
    public void constructTest10() {
        ...
        RandomTargetAddress result2 = RandomTargetAddress.CREATOR.createFromParcel(parcel);
