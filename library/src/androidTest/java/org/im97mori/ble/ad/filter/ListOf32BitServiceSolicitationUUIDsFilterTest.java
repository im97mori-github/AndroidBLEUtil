...
public class ListOf32BitServiceSolicitationUUIDsFilterTest {
    ...
    public void test_002() {
        ...
        AdvertisingDataParser parser = new AdvertisingDataParser.Builder(true).build();
        AdvertisingDataParser.AdvertisingDataParseResult result = parser.parse(actualData);
        AdvertisingDataFilter<AdvertisingDataParser.AdvertisingDataParseResult> filter = new ListOf32BitServiceSolicitationUUIDsFilter(ListOf32BitServiceSolicitationUUIDs.CREATOR.createFromByteArray(expectData));
    ...
    public void test_101() {
        ...
        AdvertisingDataParser.AdvertisingDataParseResult result = parser.parse(actualData);
        AdvertisingDataFilter<AdvertisingDataParser.AdvertisingDataParseResult> filter = new ListOf32BitServiceSolicitationUUIDsFilter(
                new ListOf32BitServiceSolicitationUUIDs(expectData, 0, expectData.length / 2 - 1)
                , new ListOf32BitServiceSolicitationUUIDs(expectData, expectData.length / 2, expectData.length / 2 - 1)
        );
        assertFalse(filter.isMatched(result));
    }
    ...
    public void test_102() {
        ...
        AdvertisingDataParser.AdvertisingDataParseResult result = parser.parse(actualData);
        AdvertisingDataFilter<AdvertisingDataParser.AdvertisingDataParseResult> filter = new ListOf32BitServiceSolicitationUUIDsFilter(
                new ListOf32BitServiceSolicitationUUIDs(expectData, 0, expectData.length - 1)
        );
        assertFalse(filter.isMatched(result));
    }
