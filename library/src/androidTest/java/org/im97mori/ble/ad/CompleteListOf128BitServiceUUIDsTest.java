...
public class CompleteListOf128BitServiceUUIDsTest {
    ...
    public void constructTest1() {
        ...
        CompleteListOf128BitServiceUUIDs result = new CompleteListOf128BitServiceUUIDs(data, 0, data[0]);
        assertEquals(17, result.getLength());
        assertEquals(DATA_TYPE_COMPLETE_LIST_OF_128_BIT_SERVICE_UUIDS, result.getDataType());
    ...
    public void constructTest10() {
        ...
        CompleteListOf128BitServiceUUIDs result2 = CompleteListOf128BitServiceUUIDs.CREATOR.createFromParcel(parcel);
    ...
    public void constructTest11() {
        ...
        CompleteListOf128BitServiceUUIDs result1 = new CompleteListOf128BitServiceUUIDs(data, 0, data[0]);
        CompleteListOf128BitServiceUUIDs result2 = CompleteListOf128BitServiceUUIDs.CREATOR.createFromByteArray(data);
