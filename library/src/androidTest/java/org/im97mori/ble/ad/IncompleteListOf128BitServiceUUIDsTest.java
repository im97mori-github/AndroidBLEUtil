...
public class IncompleteListOf128BitServiceUUIDsTest {
    ...
    public void constructTest1() {
        ...
        IncompleteListOf128BitServiceUUIDs result = new IncompleteListOf128BitServiceUUIDs(data, 0, data[0]);
        assertEquals(17, result.getLength());
        assertEquals(DATA_TYPE_INCOMPLETE_LIST_OF_128_BIT_SERVICE_UUIDS, result.getDataType());
    ...
    public void constructTest10() {
        ...
        IncompleteListOf128BitServiceUUIDs result2 = IncompleteListOf128BitServiceUUIDs.CREATOR.createFromParcel(parcel);
    ...
    public void constructTest11() {
        ...
        IncompleteListOf128BitServiceUUIDs result1 = new IncompleteListOf128BitServiceUUIDs(data, 0, data[0]);
        IncompleteListOf128BitServiceUUIDs result2 = IncompleteListOf128BitServiceUUIDs.CREATOR.createFromByteArray(data);
