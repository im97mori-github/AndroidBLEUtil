...
public class RequestMtuTask extends AbstractBLETask {
    ...
    /**
     * Default timeout(millis) for connect:10sec
     */
     ...
     */
    public RequestMtuTask(@NonNull BLEConnection bleConnection, @NonNull BluetoothGatt bluetoothGatt, @NonNull TaskHandler taskHandler, int mtu, long timeout, @NonNull Bundle argument) {
    ...
    public boolean doProcess(@NonNull Message message) {
        ...
        if (this == message.obj && PROGRESS_TIMEOUT == nextProgress) {
            ...
            if (PROGRESS_REQUEST_MTU_SUCCESS == nextProgress) {
                ...
                // current:init start, next:request mtu failed
