...
public abstract class AbstractFilteredCallbackBuilder<T> {
     ...
     * <p>
     * set original parser
     * if not set, {@link org.im97mori.ble.ad.AdvertisingDataParser.Builder} with {@code true} will use
     * </p>
     *
     * @param parser {@link org.im97mori.ble.ad.AdvertisingDataParser} instance for parse
     * @return myself
     */
    @NonNull
